 ...
 * Entity: EPMMETRICS.PRESSDATA1 (DbMoto ReplicationID: 200)
 *
 * Decoded DbMoto field-mapping expressions:
 *   PRDTETME <- MakeDateTime([PRDATE])
 *   PMCRTDTM <- MakeDateTime([PMCRTD],[PMCRTT])
 *   PMUPDDTM <- MakeDateTime([PMUPDD],[PMUPDT])
 *
...
public class UDF_EPMMETRICS_PRESSDATA1 {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("PRDTETME", null);
            modified_values.put("PMCRTDTM", null);
            modified_values.put("PMUPDDTM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("PRDTETME", makeDateTime(toLocalDate(newValues.get("PRDATE"))));
                modified_values.put("PMCRTDTM", makeDateTime(toLocalDate(newValues.get("PMCRTD")), toLocalTime(newValues.get("PMCRTT"))));
                modified_values.put("PMUPDDTM", makeDateTime(toLocalDate(newValues.get("PMUPDD")), toLocalTime(newValues.get("PMUPDT"))));
        } catch (Exception e) {
