 ...
 * Entity: KBMEFCOADD.FSLSDSHX (DbMoto ReplicationID: 357)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SDCRTDTE <- MakeDateTime([SDCRTDTE],[SDCRTTIM])
 *   SDUPDDTE <- MakeDateTime([SDUPDDTE],[SDUPDTIM])
 *   SDADT <- MakeDateTime([SDADT])
 *   SDRDT <- MakeDateTime([SDRDT])
 *   SDCUSREQDT <- MakeDateTime([SDCUSREQDT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FSLSDSHX {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SDSONUM, SDDASH, SDESTPR, SDESTYR, SDESTNBR, SDESTDSH, SDAMT, SDMSTRTR, SDCALC, SDLOI, SDCRTYET, SDSTATE, SDCRTDTE, SDUPDDTE, SDCRTTIM, SDUPDTIM, SDCRTUSR, SDUPDUSR, SDPGMUSD, SDSUHR, SDBW, SDADT, SDRDT, SDRDAYS, SDBSCH, SDSFRV, SDCAP$, SDCUSREQDT, SDSCHED, SD201, SD499, SD520, SDMULTPR, SD165, SDLOCSTATE, SDPTXCPT, SDINT
        // Target columns: SDSONUM, SDDASH, SDESTPR, SDESTYR, SDESTNBR, SDESTDSH, SDAMT, SDMSTRTR, SDCALC, SDLOI, SDCRTYET, SDSTATE, SDCRTDTE, SDUPDDTE, SDCRTUSR, SDUPDUSR, SDPGMUSD, SDSUHR, SDBW, SDADT, SDRDT, SDRDAYS, SDBSCH, SDSFRV, SDCAP$, SDCUSREQDT, SDSCHED, SDLOCSTATE, SDTXCPT, SD165, SDMULTPR, SDINT, SD520, SD499, SD201

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SDCRTDTE", null);
            modified_values.put("SDUPDDTE", null);
            modified_values.put("SDADT", null);
            modified_values.put("SDRDT", null);
            modified_values.put("SDCUSREQDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SDCRTDTE", makeDateTime(toLocalDate(newValues.get("SDCRTDTE")), toLocalTime(newValues.get("SDCRTTIM"))));
                modified_values.put("SDUPDDTE", makeDateTime(toLocalDate(newValues.get("SDUPDDTE")), toLocalTime(newValues.get("SDUPDTIM"))));
                modified_values.put("SDADT", makeDateTime(toLocalDate(newValues.get("SDADT"))));
                modified_values.put("SDRDT", makeDateTime(toLocalDate(newValues.get("SDRDT"))));
                modified_values.put("SDCUSREQDT", makeDateTime(toLocalDate(newValues.get("SDCUSREQDT"))));
        } catch (Exception e) {
