 ...
 * Entity: KBM400D011.APPAY (DbMoto ReplicationID: 245)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DTEAPL <- MakeDateTime("YYYYMMDD",[DTEAPL])
 *   DTECLR <- MakeDateTime("YYYYMMDD",[DTECLR])
 ...
 */
public class UDF_KBM400D011_APPAY {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: ACT, AMTDSC, AMTPD, AUDOPR, AUDTIM, BANKNO, CURRCD, DOCSRC, DTEAPL, DTECLR, DTEEFF, DTETRN, EXRATE, EXSRCE, FAMDSC, FAMTPD, FISCAL, FSCLCC, LOC, PAYEE, PAYTYP, PERIOD, REFER, VENDNO, WEEK, YEAR
        // Target columns: RECORDID, ACT, AMTDSC, AMTPD, AUDOPR, AUDTIM, BANKNO, CURRCD, DOCSRC, DTEAPL, DTECLR, DTEEFF, DTETRN, EXRATE, EXSRCE, FAMDSC, FAMTPD, FISCAL, FSCLCC, LOC, PAYEE, PAYTYP, PERIOD, REFER, VENDNO, WEEK, YEAR

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DTEAPL", null);
            modified_values.put("DTECLR", null);
        ...
        try {
                ...
                modified_values.put("DTECLR", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("DTECLR"))));
