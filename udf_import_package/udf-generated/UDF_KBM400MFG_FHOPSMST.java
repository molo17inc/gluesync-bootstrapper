 ...
 * Entity: KBM400MFG.FHOPSMST (DbMoto ReplicationID: 264)
 *
 * Decoded DbMoto field-mapping expressions:
 *   OACTDATE <- MakeDateTime([OACTMO], [OACTDA], [OACTYR], [OACTCT])
 *   OSLMDT <- MakeDateTime("MMDDYY",[OSLMDT])
 *   OSLSDATE <- MakeDateTime("YY",[OSLSMO], [OSLSDA], [OSLSYR])
 *   OSODDATE <- MakeDateTime("YY",[OSODMO], [OSODDA], [OSODYR])
 *
...
public class UDF_KBM400MFG_FHOPSMST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("OACTDATE", null);
            modified_values.put("OSLMDT", null);
            modified_values.put("OSLSDATE", null);
            modified_values.put("OSODDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("OACTDATE", makeDateTime(toBigDecimal(newValues.get("OACTMO")), toBigDecimal(newValues.get("OACTDA")), toBigDecimal(newValues.get("OACTYR")), toBigDecimal(newValues.get("OACTCT"))));
                modified_values.put("OSLMDT", makeDateTime("MMDDYY", toBigDecimal(newValues.get("OSLMDT"))));
                modified_values.put("OSLSDATE", makeDateTime("YY", toBigDecimal(newValues.get("OSLSMO")), toBigDecimal(newValues.get("OSLSDA")), toBigDecimal(newValues.get("OSLSYR"))));
                modified_values.put("OSODDATE", makeDateTime("YY", toBigDecimal(newValues.get("OSODMO")), toBigDecimal(newValues.get("OSODDA")), toBigDecimal(newValues.get("OSODYR"))));
        } catch (Exception e) {
