 ...
 * Generated by generate_udf_import_package.py on 2026-06-19 16:50:39
 * Entity: KBMEFCOADD.FSENGSCH (DbMoto ReplicationID: 937)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SESchDate <- MakeDateTime([SESCHDATE])
 *   SEShopDue <- MakeDateTime([SESHOPDUE])
 *   SEShopRcvd <- MakeDateTime([SESHOPRCVD])
 *   SECustDue <- MakeDateTime([SECUSTDUE])
 *   SEStrlRcvd <- MakeDateTime([SESTRLRCVD])
 *   SERTFDue <- MakeDateTime([SERTFDUE])
 *   SESDDueDte <- MakeDateTime([SESDDUEDTE])
 *   SESDRcvDte <- MakeDateTime([SESDRCVDTE])
 *   SEMailDate <- MakeDateTime([SEMAILDATE])
 *   SEStrlDue <- MakeDateTime([SESTRLDUE])
 *   SEStartDte <- MakeDateTime([SESTARTDTE])
 *   SEEstDue <- MakeDateTime([SEESTDUE])
 *   SERvsdDue <- MakeDateTime([SERVSDDUE])
 *   SECmplDate <- MakeDateTime([SECMPLDATE])
 *   SECrtDtTm <- MakeDateTime([SECRTDT],[SECRTTM])
 *   SEUpdDtTm <- MakeDateTime([SEUPDDT],[SEUPDTM])
 *
...
public class UDF_KBMEFCOADD_FSENGSCH {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SESchDate", null);
            modified_values.put("SEShopDue", null);
            modified_values.put("SEShopRcvd", null);
            modified_values.put("SECustDue", null);
            modified_values.put("SEStrlRcvd", null);
            modified_values.put("SERTFDue", null);
            modified_values.put("SESDDueDte", null);
            modified_values.put("SESDRcvDte", null);
            modified_values.put("SEMailDate", null);
            modified_values.put("SEStrlDue", null);
            modified_values.put("SEStartDte", null);
            modified_values.put("SEEstDue", null);
            modified_values.put("SERvsdDue", null);
            modified_values.put("SECmplDate", null);
            modified_values.put("SECrtDtTm", null);
            modified_values.put("SEUpdDtTm", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SESchDate", makeDateTime(toLocalDate(newValues.get("SESCHDATE"))));
                modified_values.put("SEShopDue", makeDateTime(toLocalDate(newValues.get("SESHOPDUE"))));
                modified_values.put("SEShopRcvd", makeDateTime(toLocalDate(newValues.get("SESHOPRCVD"))));
                modified_values.put("SECustDue", makeDateTime(toLocalDate(newValues.get("SECUSTDUE"))));
                modified_values.put("SEStrlRcvd", makeDateTime(toLocalDate(newValues.get("SESTRLRCVD"))));
                modified_values.put("SERTFDue", makeDateTime(toLocalDate(newValues.get("SERTFDUE"))));
                modified_values.put("SESDDueDte", makeDateTime(toLocalDate(newValues.get("SESDDUEDTE"))));
                modified_values.put("SESDRcvDte", makeDateTime(toLocalDate(newValues.get("SESDRCVDTE"))));
                modified_values.put("SEMailDate", makeDateTime(toLocalDate(newValues.get("SEMAILDATE"))));
                modified_values.put("SEStrlDue", makeDateTime(toLocalDate(newValues.get("SESTRLDUE"))));
                modified_values.put("SEStartDte", makeDateTime(toLocalDate(newValues.get("SESTARTDTE"))));
                modified_values.put("SEEstDue", makeDateTime(toLocalDate(newValues.get("SEESTDUE"))));
                modified_values.put("SERvsdDue", makeDateTime(toLocalDate(newValues.get("SERVSDDUE"))));
                modified_values.put("SECmplDate", makeDateTime(toLocalDate(newValues.get("SECMPLDATE"))));
                modified_values.put("SECrtDtTm", makeDateTime(toLocalDate(newValues.get("SECRTDT")), toLocalTime(newValues.get("SECRTTM"))));
                modified_values.put("SEUpdDtTm", makeDateTime(toLocalDate(newValues.get("SEUPDDT")), toLocalTime(newValues.get("SEUPDTM"))));
        } catch (Exception e) {
