 ...
 * Entity: KBMEFCOADD.FERRWCTR (DbMoto ReplicationID: 1120)
 *
 * Decoded DbMoto field-mapping expressions:
 *   EWUPDDATETIME <- MakeDateTime([EWUPDD],[EWUPDT])
 *   EWCRTDATETIME <- MakeDateTime([EWCRTD],[EWCRTT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FERRWCTR {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: EWWCTR, EWUPDU, EWUPDT, EWUPDD, EWPGMN, EWDESC, EWDEP2, EWDEPT, EWCRTU, EWCRTT, EWCRTD, EWCO
        // Target columns: EWPGMN, EWUPDU, EWCRTU, EWUPDDATETIME, EWCRTDATETIME, EWCO, EWDEP2, EWDEPT, EWDESC, EWWCTR

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("EWUPDDATETIME", null);
            modified_values.put("EWCRTDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("EWUPDDATETIME", makeDateTime(toLocalDate(newValues.get("EWUPDD")), toLocalTime(newValues.get("EWUPDT"))));
                modified_values.put("EWCRTDATETIME", makeDateTime(toLocalDate(newValues.get("EWCRTD")), toLocalTime(newValues.get("EWCRTT"))));
        } catch (Exception e) {
