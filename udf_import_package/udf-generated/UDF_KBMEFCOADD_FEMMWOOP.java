 ...
 * Entity: KBMEFCOADD.FEMMWOOP (DbMoto ReplicationID: 301)
 *
 * Decoded DbMoto field-mapping expressions:
 *   WOCDT <- MakeDateTime([WOCDT])
 *   OCCRTDTM <- MakeDateTime([OCCRTD],[OCCRTT])
 *   OCUPDDTM <- MakeDateTime([OCUPDD],[OCUPDT])
 *   WOSTRTRDTM <- MakeDateTime([WOSTRTDT],[WOSTRTTM])
 *   WOCOMPDTM <- MakeDateTime([WOCDT],[OCUPDT])
 *
...
public class UDF_KBMEFCOADD_FEMMWOOP {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("WOCDT", null);
            modified_values.put("OCCRTDTM", null);
            modified_values.put("OCUPDDTM", null);
            modified_values.put("WOSTRTRDTM", null);
            modified_values.put("WOCOMPDTM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("WOCDT", makeDateTime(toLocalDate(newValues.get("WOCDT"))));
                modified_values.put("OCCRTDTM", makeDateTime(toLocalDate(newValues.get("OCCRTD")), toLocalTime(newValues.get("OCCRTT"))));
                modified_values.put("OCUPDDTM", makeDateTime(toLocalDate(newValues.get("OCUPDD")), toLocalTime(newValues.get("OCUPDT"))));
                modified_values.put("WOSTRTRDTM", makeDateTime(toLocalDate(newValues.get("WOSTRTDT")), toLocalTime(newValues.get("WOSTRTTM"))));
                modified_values.put("WOCOMPDTM", makeDateTime(toLocalDate(newValues.get("WOCDT")), toLocalTime(newValues.get("OCUPDT"))));
        } catch (Exception e) {
