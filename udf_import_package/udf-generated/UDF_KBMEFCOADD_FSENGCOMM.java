 ...
 * Entity: KBMEFCOADD.FSENGCOMM (DbMoto ReplicationID: 324)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SECCrtDtTm <- MakeDateTime([SECCRTDT],[SECCRTTM])
 *   SECUpdDtTm <- MakeDateTime([SECUPDDT],[SECUPDTM])
 *
 ...
 */
public class UDF_KBMEFCOADD_FSENGCOMM {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SECO, SESLSORD, SESCHTYPE, SESCHNUM, SESCHSEQ, SECOMM, SECOMSEQ, SECCUSER, SECCPGMN, SECCRTDT, SECCRTTM, SECUUSER, SECUPGMN, SECUPDDT, SECUPDTM
        // Target columns: SECo, SESlsOrd, SESchType, SESchNum, SESchSeq, SEComm, SEComSeq, SECCUser, SECCPgmn, SECCrtDtTm, SECUUser, SECUPgmn, SECUpdDtTm

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SECCrtDtTm", null);
            modified_values.put("SECUpdDtTm", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SECCrtDtTm", makeDateTime(toLocalDate(newValues.get("SECCRTDT")), toLocalTime(newValues.get("SECCRTTM"))));
                modified_values.put("SECUpdDtTm", makeDateTime(toLocalDate(newValues.get("SECUPDDT")), toLocalTime(newValues.get("SECUPDTM"))));
        } catch (Exception e) {
