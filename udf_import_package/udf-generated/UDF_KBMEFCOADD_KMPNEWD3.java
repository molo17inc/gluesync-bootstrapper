 ...
 * Entity: KBMEFCOADD.KMPNEWD3 (DbMoto ReplicationID: 335)
 *
 * Decoded DbMoto field-mapping expressions:
 *   OMRDT <- MakeDateTime([OMRDT])
 *   FHCRTDATE <- MakeDateTime([FHCRTD],[FHCRTT])
 *   FHUPDDATE <- MakeDateTime([FHUPDD],[FHUPDT])
 *
...
public class UDF_KBMEFCOADD_KMPNEWD3 {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("OMRDT", null);
            modified_values.put("FHCRTDATE", null);
            modified_values.put("FHUPDDATE", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("OMRDT", makeDateTime(toLocalDate(newValues.get("OMRDT"))));
                modified_values.put("FHCRTDATE", makeDateTime(toLocalDate(newValues.get("FHCRTD")), toLocalTime(newValues.get("FHCRTT"))));
                modified_values.put("FHUPDDATE", makeDateTime(toLocalDate(newValues.get("FHUPDD")), toLocalTime(newValues.get("FHUPDT"))));
