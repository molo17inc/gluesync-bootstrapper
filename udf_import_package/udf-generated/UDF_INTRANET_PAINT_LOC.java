 ...
 * Entity: INTRANET.PAINT_LOC (DbMoto ReplicationID: 224)
 *
 ...
 */
public class UDF_INTRANET_PAINT_LOC {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: LOC_ID, LOC, QTY, KITCHEN, INVENTORY_ID, TIME_STAMP
        // Target columns: LOC_ID, LOC, QTY, KITCHEN, INVENTORY_ID, TIME_STAMP
