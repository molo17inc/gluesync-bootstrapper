 ...
 * Entity: KBMEFCOADD.FAUTWODET (DbMoto ReplicationID: 292)
 *
 * Decoded DbMoto field-mapping expressions:
 *   AWCDUE <- MakeDateTime([AWCDUE])
 *   AWCSTR <- MakeDateTime([AWCSTR])
 *   AWPDUE <- MakeDateTime([AWPDUE])
 *   AWPSTR <- MakeDateTime([AWPSTR])
 *
...
public class UDF_KBMEFCOADD_FAUTWODET {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("AWCDUE", null);
            modified_values.put("AWCSTR", null);
            modified_values.put("AWPDUE", null);
            modified_values.put("AWPSTR", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("AWCDUE", makeDateTime(toLocalDate(newValues.get("AWCDUE"))));
                modified_values.put("AWCSTR", makeDateTime(toLocalDate(newValues.get("AWCSTR"))));
                modified_values.put("AWPDUE", makeDateTime(toLocalDate(newValues.get("AWPDUE"))));
                modified_values.put("AWPSTR", makeDateTime(toLocalDate(newValues.get("AWPSTR"))));
        } catch (Exception e) {
