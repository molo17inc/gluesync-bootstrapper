 ...
 * Entity: ESPRODLIB.INPMREFF (DbMoto ReplicationID: 212)
 *
 * Decoded DbMoto field-mapping expressions:
 *   HLDATCRTDATE <- MakeDateTime([HLDATCRT],[HLTIMCRT])
 *   HLDATUPDDATE <- MakeDateTime([HLDATUPD],[HLTIMUPD])
 *
 ...
 */
public class UDF_ESPRODLIB_INPMREFF {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CYEAR, CNMBR, CDASH, PRTNB, CTFTYP, CTFCLS, CTFCOL, CTFMIS, CALLNG, CALQTY, CALEFF, CALITM, HLCONBR, HLDATCRT, HLDATUPD, HLTIMCRT, HLTIMUPD, HLUSRCRT, HLUSRUPD, HLPGMNAM
        // Target columns: RECORDID, CYEAR, CNMBR, CDASH, PRTNB, CTFTYP, CTFCLS, CTFCOL, CTFMIS, CALLNG, CALQTY, CALEFF, CALITM, HLCONBR, HLDATCRTDATE, HLDATUPDDATE, HLUSRCRT, HLUSRUPD, HLPGMNAM

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("HLDATCRTDATE", null);
            modified_values.put("HLDATUPDDATE", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("HLDATCRTDATE", makeDateTime(toLocalDate(newValues.get("HLDATCRT")), toLocalTime(newValues.get("HLTIMCRT"))));
                modified_values.put("HLDATUPDDATE", makeDateTime(toLocalDate(newValues.get("HLDATUPD")), toLocalTime(newValues.get("HLTIMUPD"))));
