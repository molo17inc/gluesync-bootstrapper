 ...
 * Entity: KBMEFCOADD.FESOMM01 (DbMoto ReplicationID: 306)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SXCRTDTM <- MakeDateTime([SXCRTD],[SXCRTT])
 *   SXUPDDTM <- MakeDateTime([SXUPDD],[SXUPDT])
 *
...
public class UDF_KBMEFCOADD_FESOMM01 {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SXCRTDTM", null);
            modified_values.put("SXUPDDTM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SXCRTDTM", makeDateTime(toLocalDate(newValues.get("SXCRTD")), toLocalTime(newValues.get("SXCRTT"))));
                modified_values.put("SXUPDDTM", makeDateTime(toLocalDate(newValues.get("SXUPDD")), toLocalTime(newValues.get("SXUPDT"))));
        } catch (Exception e) {
