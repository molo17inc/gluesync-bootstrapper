 ...
 * Entity: KBMEFCOADD.SALES (DbMoto ReplicationID: 343)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DATEORD <- MakeDateTime([DATEORD])
 *   DATEDUE <- MakeDateTime([DATEDUE])
 *
 ...
 */
public class UDF_KBMEFCOADD_SALES {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CHONO, JOBNAM, CHSTS, CHCSPO, CHPRJ, CDLINE, CDSTS, CDTXIMTX, JOB#, CYEAR, CNMBR, CDASH, MARK, COMMENT, JLFINWAR, JLGLSWAR, JLWINWAR, JLSTFWAR, JLCTWWAR, CHBTCN, CMBNAM, CHSTCN, CMSNAM, CMSLSM, SLCODE, SLNAME, SLFNAME, SLLNAME, SLAGENT, ARCHTC, ARCHT1, CMBAD1, CMBAD2, CMBAD3, CMBAD4, CMBAD5, CMBZIP, SOLDCOUNTY, SOLDSTATE1, SOLDSTATE2, CHCRTY, SOLDCNTRY, CNTRYSOLD, CMSAD1, CMSAD2, CMSAD3, CMSAD4, CMSAD5, CMSZIP, SHIPCOUNTY, SHIPSTATE1, SHIPSTATE2, CHSCCD, SHIPCNTRY, CNTRYSHIP, CHREGN, REGNAME, CHTER, TERNAME, CHCO, COADD2, FACTYPE, SLCO, ARCADR, ARCHCT, ARCHST, ARCZIP, PDCATE, IMCLS, SERIES, GUESSSERIE, ODDSSERIE1, SERIES1, SERIES2, SERIES3, CDPN, CDDESC, STDEXPEXP, ORIGN, ORIGTXT, WIDTH, HEIGHT, CONFIG, FINISH_EXT, FTYPE_EXT, FCLASS_EXT, FCOLOR_EXT, FMISC_EXT, FDESC1_EXT, FDESC2_EXT, FDESC3_EXT, FDESC4_EXT, FINISH_INT, FTYPE_INT, FCLASS_INT, FCOLOR_INT, FMISC_INT, FDESC1_INT, FDESC2_INT, FDESC3_INT, FDESC4_INT, OPERORFIX, HEATMIR, PANEL, INTMUNTIN, WHATMUNT, GRID, WHATGRID, BLIND, SCREEN, SIGHT, SPEC_FAB, INT_PANEL, WHATIPNL, HDLEG, SLLEG, LJLEG, RJLEG, PROFILE, DATEORD, CHODYR, CHODMO, CHODDA, DATEDUE, CHORYR, CHORMO, CHORDA, CDSQTY, MKQTY, CDUPRI, PRICE, SQFTFIN_PR, SQFTFIN_EX, SQFTFIN_IN, SQFTFIN_TO, LBSALUM_PR, LBSALUM_TO, SQFTWDW_PR, SQFTWDW_TO, QTYLITEPER, QTYLITETOT, CUINFIL_PR, CUINFIL_TO, LIFTFIL_PR, LIFTFIL_TO, LIFTISB_PR, LIFTISB_TO
        // Target columns: RECORDID, CHONO, JOBNAM, CHSTS, CHCSPO, CHPRJ, CDLINE, CDSTS, CDTXIMTX, JOB#, CYEAR, CNMBR, CDASH, MARK, COMMENT, JLFINWAR, JLGLSWAR, JLWINWAR, JLSTFWAR, JLCTWWAR, CHBTCN, CMBNAM, CHSTCN, CMSNAM, CMSLSM, SLCODE, SLNAME, SLFNAME, SLLNAME, SLAGENT, ARCHTC, ARCHT1, CMBAD1, CMBAD2, CMBAD3, CMBAD4, CMBAD5, CMBZIP, SOLDCOUNTY, SOLDSTATE1, SOLDSTATE2, CHCRTY, SOLDCNTRY, CNTRYSOLD, CMSAD1, CMSAD2, CMSAD3, CMSAD4, CMSAD5, CMSZIP, SHIPCOUNTY, SHIPSTATE1, SHIPSTATE2, CHSCCD, SHIPCNTRY, CNTRYSHIP, CHREGN, REGNAME, CHTER, TERNAME, CHCO, COADD2, FACTYPE, SLCO, ARCADR, ARCHCT, ARCHST, ARCZIP, PDCATE, IMCLS, SERIES, GUESSSERIE, ODDSSERIE1, SERIES1, SERIES2, SERIES3, CDPN, CDDESC, STDEXPEXP, ORIGN, ORIGTXT, WIDTH, HEIGHT, CONFIG, FINISH_EXT, FTYPE_EXT, FCLASS_EXT, FCOLOR_EXT, FMISC_EXT, FDESC1_EXT, FDESC2_EXT, FDESC3_EXT, FDESC4_EXT, FINISH_INT, FTYPE_INT, FCLASS_INT, FCOLOR_INT, FMISC_INT, FDESC1_INT, FDESC2_INT, FDESC3_INT, FDESC4_INT, OPERORFIX, HEATMIR, PANEL, INTMUNTIN, WHATMUNT, GRID, WHATGRID, BLIND, SCREEN, SIGHT, SPEC_FAB, INT_PANEL, WHATIPNL, HDLEG, SLLEG, LJLEG, RJLEG, PROFILE, DATEORD, DATEDUE, CDSQTY, MKQTY, CDUPRI, PRICE, SQFTFIN_PR, SQFTFIN_EX, SQFTFIN_IN, SQFTFIN_TO, LBSALUM_PR, LBSALUM_TO, SQFTWDW_PR, SQFTWDW_TO, QTYLITEPER, QTYLITETOT, CUINFIL_PR, CUINFIL_TO, LIFTFIL_PR, LIFTFIL_TO, LIFTISB_PR, LIFTISB_TO

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DATEORD", null);
            modified_values.put("DATEDUE", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DATEORD", makeDateTime(toLocalDate(newValues.get("DATEORD"))));
                modified_values.put("DATEDUE", makeDateTime(toLocalDate(newValues.get("DATEDUE"))));
