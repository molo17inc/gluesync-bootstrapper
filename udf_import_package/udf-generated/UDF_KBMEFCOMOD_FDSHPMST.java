 ...
 * Entity: KBMEFCOMOD.FDSHPMST (DbMoto ReplicationID: 344)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SMSDDATE <- MakeDateTime([SMSDMM],[SMSDDD],[SMSDYY],[SMSDCC])
 *   SMCMDT <- MakeDateTime("MMDDYY",[SMCMDT])
 *   SMCDATE <- MakeDateTime(MakeDateTime("MMDDYY",[SMCMDT]),[SMCTIM])
 *
 ...
 */
public class UDF_KBMEFCOMOD_FDSHPMST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SMCOFM, SMCOTO, SMSDCC, SMSDYY, SMSDMM, SMSDDD, SMSTYP, SMSCAR, SMSVEH, SMNVEH, SMMXWT, SMMXCB, SMPCWT, SMPCCB, SMUNLD, SMRTGC, SMDORD, SMCLWT, SMCLCB, SMALWT, SMALCB, SMCMSG, SMCMDT, SMCTIM, SMCDAT, SMBOL, SMLOFC, SMINI
        // Target columns: RECORDID, SMCOFM, SMCOTO, SMSDDATE, SMSTYP, SMSCAR, SMSVEH, SMNVEH, SMMXWT, SMMXCB, SMPCWT, SMPCCB, SMUNLD, SMRTGC, SMDORD, SMCLWT, SMCLCB, SMALWT, SMALCB, SMCMSG, SMCMDT, SMCDATE, SMBOL, SMLOFC, SMINI

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SMSDDATE", null);
            modified_values.put("SMCMDT", null);
            modified_values.put("SMCDATE", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SMSDDATE", makeDateTime(toBigDecimal(newValues.get("SMSDMM")), toBigDecimal(newValues.get("SMSDDD")), toBigDecimal(newValues.get("SMSDYY")), toBigDecimal(newValues.get("SMSDCC"))));
                modified_values.put("SMCMDT", makeDateTime("MMDDYY", toBigDecimal(newValues.get("SMCMDT"))));
                modified_values.put("SMCDATE", makeDateTime((LocalDate)makeDateTime("MMDDYY", toBigDecimal(newValues.get("SMCMDT"))), toBigDecimal(newValues.get("SMCTIM"))));
