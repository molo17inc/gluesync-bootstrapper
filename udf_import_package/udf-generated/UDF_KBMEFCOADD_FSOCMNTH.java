 ...
 * Entity: KBMEFCOADD.FSOCMNTH (DbMoto ReplicationID: 329)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SOHCDAT <- LowDate(MakeDateTime([SOHCDAT],[SOHCTIM]))
 *   SOHCMPD <- MakeDateTime([SOHCMPD])
 *
 ...
 */
public class UDF_KBMEFCOADD_FSOCMNTH {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SOHDCO, SOHNUM, SOHLINE, SOHOPT, SOHCDAT, SOHCTIM, SOHUSER, SOHPART, SOHCMPD, SOHDASH, SOHSHIP
        // Target columns: SOHDCO, SOHNUM, SOHLINE, SOHOPT, SOHCDAT, SOHUSER, SOHPART, SOHCMPD, SOHDASH, SOHSHIP

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SOHCDAT", null);
            modified_values.put("SOHCMPD", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SOHCDAT", lowDate(makeDateTime(toLocalDate(newValues.get("SOHCDAT")), toLocalTime(newValues.get("SOHCTIM")))));
                modified_values.put("SOHCMPD", makeDateTime(toLocalDate(newValues.get("SOHCMPD"))));
        } catch (Exception e) {
