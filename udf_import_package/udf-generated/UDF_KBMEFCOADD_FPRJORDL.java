 ...
 * Entity: KBMEFCOADD.FPRJORDL (DbMoto ReplicationID: 317)
 *
 * Decoded DbMoto field-mapping expressions:
 *   JLPODTE <- MakeDateTime([JLPODTE])
 *   JLREQDTE <- MakeDateTime([JLREQDTE])
 *   JLESTDTE <- MakeDateTime([JLESTDTE])
 *   JLCRTDTETM <- MakeDateTime([JLCRTDTE],[JLCRTTIM])
 *   JLUPDDTETM <- MakeDateTime([JLUPDDTE],[JLUPDTIM])
 *
...
public class UDF_KBMEFCOADD_FPRJORDL {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("JLPODTE", null);
            modified_values.put("JLREQDTE", null);
            modified_values.put("JLESTDTE", null);
            modified_values.put("JLCRTDTETM", null);
            modified_values.put("JLUPDDTETM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("JLPODTE", makeDateTime(toLocalDate(newValues.get("JLPODTE"))));
                modified_values.put("JLREQDTE", makeDateTime(toLocalDate(newValues.get("JLREQDTE"))));
                modified_values.put("JLESTDTE", makeDateTime(toLocalDate(newValues.get("JLESTDTE"))));
                modified_values.put("JLCRTDTETM", makeDateTime(toLocalDate(newValues.get("JLCRTDTE")), toLocalTime(newValues.get("JLCRTTIM"))));
                modified_values.put("JLUPDDTETM", makeDateTime(toLocalDate(newValues.get("JLUPDDTE")), toLocalTime(newValues.get("JLUPDTIM"))));
        } catch (Exception e) {
