 ...
 * Entity: ESPRODQA.FPARTATTR (DbMoto ReplicationID: 1070)
 *
 * Decoded DbMoto field-mapping expressions:
 *   RDUPDDT <- MakeDateTime([RDUPDD], [RDUPDT])
 *   RDCRTDT <- MakeDateTime([RDCRTD], [RDCRTT])
 *
 ...
 */
public class UDF_ESPRODQA_FPARTATTR {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: RDPGMN, RDUPDU, RDCRTU, RDUPDT, RDCRTT, RDUPDD, RDCRTD, ORIGIN, LABORLIST, DIRECTLBR, INPLLBRLST, GRIDLBRLST, SCRNLBRLST, GLZGLBRLST, GLASLBRLST, PRCTLBRLST, INPLLBR, GRIDLBR, SCREENLBR, GLAZINGLBR, GLASSLBR, PRODUCTLBR, TOTMHR, INPLMHR, GRIDMHR, SCREENMHR, GLAZINGMHR, GLASSMHR, PRODUCTMHR, GLASSRATE, GLASSCOST, GLASSSQFT, GLASSWGT, INSPRICE, FINPRICEI, FINPRICE, ALUMPRICEI, ALUMPRICE, INSSTCHLBR, INSCOST, ALUMRATEI, ALUMCOSTI, REVFCTLBSI, ALUMLBSI, FINRATEI, FINCOSTI, FINSQFTI, ALUMRATE, ALUMCOST, REVFCTLBS, ALUMLBS, FINRATE, FINCOST, FINSQFT, PARTPRICE, PARTCOST, PARTDESC, FINISHDESC, JBGLS, JBFINI, JBFIN, SERIES, WSYSTM, PDCATE, GLSTHICK, SPCRLENGTH, VTLENGTH, HZLENGTH, QUANTITY, PARTNUM, MRKQTY, MARK, ESTDSH, ESTNBR, ESTYR, ESTPRF, IMCO, BALPARTNUM
        // Target columns: RDPGMN, RDUPDU, RDCRTU, RDUPDDT, RDCRTDT, ORIGIN, LABORLIST, DIRECTLBR, INPLLBRLST, GRIDLBRLST, SCRNLBRLST, GLZGLBRLST, GLASLBRLST, PRCTLBRLST, INPLLBR, GRIDLBR, SCREENLBR, GLAZINGLBR, GLASSLBR, PRODUCTLBR, TOTMHR, INPLMHR, GRIDMHR, SCREENMHR, GLAZINGMHR, GLASSMHR, PRODUCTMHR, GLASSRATE, GLASSCOST, GLASSSQFT, GLASSWGT, INSPRICE, FINPRICEI, FINPRICE, ALUMPRICEI, ALUMPRICE, INSSTCHLBR, INSCOST, ALUMRATEI, ALUMCOSTI, REVFCTLBSI, ALUMLBSI, FINRATEI, FINCOSTI, FINSQFTI, ALUMRATE, ALUMCOST, REVFCTLBS, ALUMLBS, FINRATE, FINCOST, FINSQFT, PARTPRICE, PARTCOST, PARTDESC, FINISHDESC, JBGLS, JBFINI, JBFIN, SERIES, WSYSTM, PDCATE, GLSTHICK, SPCRLENGTH, VTLENGTH, HZLENGTH, QUANTITY, BALPARTNUM, PARTNUM, MRKQTY, MARK, ESTDSH, ESTNBR, ESTYR, ESTPRF, IMCO, RECORDID

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("RDUPDDT", null);
            modified_values.put("RDCRTDT", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("RDUPDDT", makeDateTime(toLocalDate(newValues.get("RDUPDD")), toLocalTime(newValues.get("RDUPDT"))));
                modified_values.put("RDCRTDT", makeDateTime(toLocalDate(newValues.get("RDCRTD")), toLocalTime(newValues.get("RDCRTT"))));
