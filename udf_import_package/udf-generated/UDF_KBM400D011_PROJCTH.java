 ...
 * Entity: KBM400D011.PROJCTH (DbMoto ReplicationID: 254)
 *
 * Decoded DbMoto field-mapping expressions:
 *   CHKDTE <- MakeDateTime("YYYYMMDD",[CHKDTE])
 ...
 */
public class UDF_KBM400D011_PROJCTH {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: ACT, ACTIVE, AMTDOL, APP, AUDOPR, AUDTIM, DOCEXT, DOCPO, DOCSRC, CHKDTE, CHKNBR, CO, CUSTPO, DTETRN, FISCAL, FSCLCC, LOC, PERIOD, PRJECT, QTYAMT, REFER, YEAR
        // Target columns: RECORDID, ACT, ACTIVE, AMTDOL, APP, AUDOPR, AUDTIM, DOCEXT, DOCPO, DOCSRC, CHKDTE, CHKNBR, CO, CUSTPO, DTETRN, FISCAL, FSCLCC, LOC, PERIOD, PRJECT, QTYAMT, REFER, YEAR
        ...
        try {
                modified_values.put("CHKDTE", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("CHKDTE"))));
