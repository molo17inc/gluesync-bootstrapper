 ...
 * Entity: KBM400MFG.FKSHORT (DbMoto ReplicationID: 1093)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SHDATE <- MakeDateTime("MMDDYY",[SHDATE])
 *
 ...
 */
public class UDF_KBM400MFG_FKSHORT {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SHDOWO, SHWCTR, SHVNDR, SHTOPN, SHREF, SHQTY, SHQTXP, SHPN, SHPDAT, SHONO, SHLMT, SHISS, SHEXDT, SHDTIS, SHDLT, SHDATE, SHCOMP, SHCODE, SHCO, SHBUY
        // Target columns: SHDOWO, SHWCTR, SHVNDR, SHTOPN, SHREF, SHQTY, SHQTXP, SHPN, SHPDAT, SHONO, SHLMT, SHISS, SHEXDT, SHDTIS, SHDLT, SHDATE, SHCOMP, SHCODE, SHCO, SHBUY

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SHDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SHDATE", makeDateTime("MMDDYY", toBigDecimal(newValues.get("SHDATE"))));
        } catch (Exception e) {
