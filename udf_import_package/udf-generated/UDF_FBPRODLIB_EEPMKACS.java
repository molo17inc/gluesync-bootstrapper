 ...
 * Entity: FBPRODLIB.EEPMKACS (DbMoto ReplicationID: 220)
 *
 * Decoded DbMoto field-mapping expressions:
 *   ARCRTD <- MakeDateTime([ARCRTD],[ARCRTT])
 *   ARUPDD <- MakeDateTime([ARUPDD],[ARUPDT])
 *
...
public class UDF_FBPRODLIB_EEPMKACS {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("ARCRTD", null);
            modified_values.put("ARUPDD", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("ARCRTD", makeDateTime(toLocalDate(newValues.get("ARCRTD")), toLocalTime(newValues.get("ARCRTT"))));
                modified_values.put("ARUPDD", makeDateTime(toLocalDate(newValues.get("ARUPDD")), toLocalTime(newValues.get("ARUPDT"))));
        } catch (Exception e) {
