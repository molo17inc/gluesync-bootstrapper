 ...
 * Entity: KBM400MFG.FTSLSMAN (DbMoto ReplicationID: 288)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SLCTDTTM <- MakeDateTime([SLCTDT],[SLCTTM])
 *   SLUPDTTM <- MakeDateTime([SLUPDT],[SLUPTM])
 *
...
public class UDF_KBM400MFG_FTSLSMAN {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SLCTDTTM", null);
            modified_values.put("SLUPDTTM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SLCTDTTM", makeDateTime(toLocalDate(newValues.get("SLCTDT")), toLocalTime(newValues.get("SLCTTM"))));
                modified_values.put("SLUPDTTM", makeDateTime(toLocalDate(newValues.get("SLUPDT")), toLocalTime(newValues.get("SLUPTM"))));
        } catch (Exception e) {
