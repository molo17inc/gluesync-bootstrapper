 ...
 * Entity: ESPRODLIB.FESTSQUOTE (DbMoto ReplicationID: 684)
 *
 * Decoded DbMoto field-mapping expressions:
 *   EQCOMP <- MakeDateTime([EQCOMP])
 *   EQCRTDATETIME <- MakeDateTime([EQCRTD],[EQCRTT])
 *   EQUPDDATETIME <- MakeDateTime([EQUPDD],[EQUPDT])
 *
 ...
 */
public class UDF_ESPRODLIB_FESTSQUOTE {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: EQCO, EQCODE, EQPRF, EQYR, EQNBR, EQDSH, EQEEP, EQNEP, EQBO, EQSUM, EQFROZEN, EQCMT1, EQCMT2, EQCOMP, EQPROC, EQCRTD, EQCRTT, EQCRTU, EQUPDD, EQUPDT, EQUPDU, EQPGMN
        // Target columns: EQCO, EQCODE, EQPRF, EQYR, EQNBR, EQDSH, EQEEP, EQNEP, EQBO, EQSUM, EQFROZEN, EQCMT1, EQCMT2, EQCOMP, EQPROC, EQCRTDATETIME, EQCRTU, EQUPDDATETIME, EQUPDU, EQPGMN

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("EQCOMP", null);
            modified_values.put("EQCRTDATETIME", null);
            modified_values.put("EQUPDDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("EQCOMP", makeDateTime(toLocalDate(newValues.get("EQCOMP"))));
                modified_values.put("EQCRTDATETIME", makeDateTime(toLocalDate(newValues.get("EQCRTD")), toLocalTime(newValues.get("EQCRTT"))));
                modified_values.put("EQUPDDATETIME", makeDateTime(toLocalDate(newValues.get("EQUPDD")), toLocalTime(newValues.get("EQUPDT"))));
        } catch (Exception e) {
