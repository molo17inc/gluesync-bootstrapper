 ...
 * Entity: KBM400MFG.FKPSTRUC (DbMoto ReplicationID: 269)
 *
 * Decoded DbMoto field-mapping expressions:
 *   PSEXDATE <- MakeDateTime([PSEXMO],[PSEXDA],[PSEXYR],[PSEXCT])
 *   PSUDATE <- MakeDateTime("YYYYMMDD",[PSUDTE])
 *
 ...
 */
public class UDF_KBM400MFG_FKPSTRUC {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: PSABOM, PSCCST, PSCDEC, PSCMRN, PSCMRS, PSCO, PSDEC, PSDRWP, PSDRWR, PSDUOM, PSECN, PSEFCT, PSEFDA, PSEFMO, PSEFYR, PSEXCT, PSEXDA, PSEXMO, PSEXYR, PSFLG1, PSIO, PSLDOF, PSOPR, PSOREF, PSPMRN, PSPMRS, PSPRNG, PSQBC, PSQTY, PSQTYN, PSSCN, PSSCQN, PSSCQY, PSSDEC, PSSEQ, PSTYPE, PSUDTE, PSUEVT, PSUPGM, PSUTGT, PSUTIM, PSUUSR, PSYLD, PSYUMN, PSYUOM
        // Target columns: RECORDID, PSABOM, PSCCST, PSCDEC, PSCMRN, PSCMRS, PSCO, PSDEC, PSDRWP, PSDRWR, PSDUOM, PSECN, PSEFCT, PSEFYR, PSEFMO, PSEFDA, PSEXDATE, PSFLG1, PSIO, PSLDOF, PSOPR, PSOREF, PSPMRN, PSPMRS, PSPRNG, PSQBC, PSQTY, PSQTYN, PSSCN, PSSCQN, PSSCQY, PSSDEC, PSSEQ, PSTYPE, PSUDATE, PSUEVT, PSUPGM, PSUTGT, PSUUSR, PSYLD, PSYUMN, PSYUOM

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("PSEXDATE", null);
            modified_values.put("PSUDATE", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("PSEXDATE", makeDateTime(toBigDecimal(newValues.get("PSEXMO")), toBigDecimal(newValues.get("PSEXDA")), toBigDecimal(newValues.get("PSEXYR")), toBigDecimal(newValues.get("PSEXCT"))));
                modified_values.put("PSUDATE", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("PSUDTE"))));
