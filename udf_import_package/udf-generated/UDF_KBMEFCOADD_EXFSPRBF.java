 ...
 * Entity: KBMEFCOADD.EXFSPRBF (DbMoto ReplicationID: 291)
 *
 * Decoded DbMoto field-mapping expressions:
 *   MPCRTDT <- MakeDateTime([MPCRTD],[MPCRTT])
 *   MPUPDDT <- MakeDateTime([MPUPDD],[MPUPDT])
 *
 ...
 */
public class UDF_KBMEFCOADD_EXFSPRBF {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: MPCO#, MPEXP#, MPJOB#, MPJOB5#, MPERRACD, MPCONUM, MPJOBDSH, MPPRDCAT, MPWRKCTR, MPFSERROR, MPFSPRB#, MPMLTPRB, MPDELETED, MPCRTD, MPCRTT, MPCRTU, MPUPDD, MPUPDT, MPUPDU, MPPGMN, MPERRSCD, MPEXPCAT
        // Target columns: RecordID, MPCO#, MPEXP#, MPJOB#, MPJOB5#, MPERRACD, MPCONUM, MPJOBDSH, MPPRDCAT, MPWRKCTR, MPFSERROR, MPFSPRB#, MPMLTPRB, MPDELETED, MPCRTDT, MPCRTU, MPUPDDT, MPUPDU, MPPGMN, MPERRSCD, MPEXPCAT

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("MPCRTDT", null);
            modified_values.put("MPUPDDT", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("MPCRTDT", makeDateTime(toLocalDate(newValues.get("MPCRTD")), toLocalTime(newValues.get("MPCRTT"))));
                modified_values.put("MPUPDDT", makeDateTime(toLocalDate(newValues.get("MPUPDD")), toLocalTime(newValues.get("MPUPDT"))));
