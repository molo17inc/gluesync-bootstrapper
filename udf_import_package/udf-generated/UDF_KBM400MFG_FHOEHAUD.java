 ...
 * Generated by generate_udf_import_package.py on 2026-06-19 16:50:40
 * Entity: KBM400MFG.FHOEHAUD (DbMoto ReplicationID: 1107)
 *
 * Decoded DbMoto field-mapping expressions:
 *   NHODDATETIME <- MakeDateTime([NHODMO],[NHODDA],[NHODYR],[NHODCT])
 *   CHODDATETIME <- MakeDateTime([CHODMO],[CHODDA],[CHODYR],[CHODCT])
 *   OHTRGDATETIME <- LowDate(MakeDateTime(MakeDateTime("CYYMMDD", [OHTRGD]), [OHTRGT]))
 *
...
public class UDF_KBM400MFG_FHOEHAUD {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("NHODDATETIME", null);
            modified_values.put("CHODDATETIME", null);
            modified_values.put("OHTRGDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("NHODDATETIME", makeDateTime(toBigDecimal(newValues.get("NHODMO")), toBigDecimal(newValues.get("NHODDA")), toBigDecimal(newValues.get("NHODYR")), toBigDecimal(newValues.get("NHODCT"))));
                modified_values.put("CHODDATETIME", makeDateTime(toBigDecimal(newValues.get("CHODMO")), toBigDecimal(newValues.get("CHODDA")), toBigDecimal(newValues.get("CHODYR")), toBigDecimal(newValues.get("CHODCT"))));
                modified_values.put("OHTRGDATETIME", lowDate(makeDateTime((LocalDate)makeDateTime("CYYMMDD", toBigDecimal(newValues.get("OHTRGD"))), toBigDecimal(newValues.get("OHTRGT")))));
        } catch (Exception e) {
