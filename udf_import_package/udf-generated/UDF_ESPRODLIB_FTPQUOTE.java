 ...
 * Entity: ESPRODLIB.FTPQUOTE (DbMoto ReplicationID: 211)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DATSYS <- MakeDateTime([DATSYS],[TIMSYS])
 *   RCVDTE <- MakeDateTime([RCVDTE])
 *   RQDATE <- MakeDateTime([RQDATE])
 *   ASNDTE <- MakeDateTime([ASNDTE])
 *   PRTDTE <- MakeDateTime([PRTDTE])
 *   BIDDTE <- MakeDateTime([BIDDTE])
 *   CHKDTE <- MakeDateTime([CHKDTE])
 *   PPSDT <- MakeDateTime([PPSDT])
 *   FPSDT <- MakeDateTime([FPSDT])
 *   FPSADT <- MakeDateTime([FPSADT])
 *   PSPDT <- MakeDateTime([PSPDT])
 *   FSPDT <- MakeDateTime([FSPDT])
 *   FTDATCTM <- MakeDateTime([FTDATC],[FTTIMC])
 *   FTDATUTM <- MakeDateTime([FTDATU],[FTTIMU])
 *
...
public class UDF_ESPRODLIB_FTPQUOTE {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DATSYS", null);
            modified_values.put("RCVDTE", null);
            modified_values.put("RQDATE", null);
            modified_values.put("ASNDTE", null);
            modified_values.put("PRTDTE", null);
            modified_values.put("BIDDTE", null);
            modified_values.put("CHKDTE", null);
            modified_values.put("PPSDT", null);
            modified_values.put("FPSDT", null);
            modified_values.put("FPSADT", null);
            modified_values.put("PSPDT", null);
            modified_values.put("FSPDT", null);
            modified_values.put("FTDATCTM", null);
            modified_values.put("FTDATUTM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DATSYS", makeDateTime(toLocalDate(newValues.get("DATSYS")), toBigDecimal(newValues.get("TIMSYS"))));
                modified_values.put("RCVDTE", makeDateTime(toLocalDate(newValues.get("RCVDTE"))));
                modified_values.put("RQDATE", makeDateTime(toLocalDate(newValues.get("RQDATE"))));
                modified_values.put("ASNDTE", makeDateTime(toLocalDate(newValues.get("ASNDTE"))));
                modified_values.put("PRTDTE", makeDateTime(toLocalDate(newValues.get("PRTDTE"))));
                modified_values.put("BIDDTE", makeDateTime(toLocalDate(newValues.get("BIDDTE"))));
                modified_values.put("CHKDTE", makeDateTime(toLocalDate(newValues.get("CHKDTE"))));
                modified_values.put("PPSDT", makeDateTime(toLocalDate(newValues.get("PPSDT"))));
                modified_values.put("FPSDT", makeDateTime(toLocalDate(newValues.get("FPSDT"))));
                modified_values.put("FPSADT", makeDateTime(toLocalDate(newValues.get("FPSADT"))));
                modified_values.put("PSPDT", makeDateTime(toLocalDate(newValues.get("PSPDT"))));
                modified_values.put("FSPDT", makeDateTime(toLocalDate(newValues.get("FSPDT"))));
                modified_values.put("FTDATCTM", makeDateTime(toLocalDate(newValues.get("FTDATC")), toLocalTime(newValues.get("FTTIMC"))));
                modified_values.put("FTDATUTM", makeDateTime(toLocalDate(newValues.get("FTDATU")), toLocalTime(newValues.get("FTTIMU"))));
        } catch (Exception e) {
