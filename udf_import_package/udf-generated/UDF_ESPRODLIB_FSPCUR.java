 ...
 * Entity: ESPRODLIB.FSPCUR (DbMoto ReplicationID: 210)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DATECR <- MakeDateTime([DATECR],[TIMECR])
 *   DATEUP <- MakeDateTime([DATEUP],[TIMEUP])
 *   BXCRTD <- MakeDateTime([BXCRTD],[BXCRTT])
 *   BXUPDD <- MakeDateTime([BXUPDD],[BXUPDT])
 *
...
public class UDF_ESPRODLIB_FSPCUR {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DATECR", null);
            modified_values.put("DATEUP", null);
            modified_values.put("BXCRTD", null);
            modified_values.put("BXUPDD", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DATECR", makeDateTime(toLocalDate(newValues.get("DATECR")), toBigDecimal(newValues.get("TIMECR"))));
                modified_values.put("DATEUP", makeDateTime(toLocalDate(newValues.get("DATEUP")), toBigDecimal(newValues.get("TIMEUP"))));
                modified_values.put("BXCRTD", makeDateTime(toLocalDate(newValues.get("BXCRTD")), toLocalTime(newValues.get("BXCRTT"))));
                modified_values.put("BXUPDD", makeDateTime(toLocalDate(newValues.get("BXUPDD")), toLocalTime(newValues.get("BXUPDT"))));
