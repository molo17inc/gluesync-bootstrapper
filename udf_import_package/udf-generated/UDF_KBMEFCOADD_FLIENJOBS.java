 ...
 * Entity: KBMEFCOADD.FLIENJOBS (DbMoto ReplicationID: 991)
 *
 * Decoded DbMoto field-mapping expressions:
 *   LJENTDTE <- MakeDateTime([LJENTDTE])
 *   LJPRCDTE <- MakeDateTime([LJPRCDTE])
 *   LJSTSDTE <- MakeDateTime([LJSTSDTE])
 *   LJCRTDATETIME <- MakeDateTime([LJCRTD],[LJCRTT])
 *   LJUPDDATETIME <- MakeDateTime([LJUPDD],[LJUPDT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FLIENJOBS {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: LJCHCO, LJCUST, LJJOB, LJCODE, LJENTDTE, LJPRCDTE, LJSTATUS, LJSTSDTE, LJCRTD, LJCRTT, LJCRTU, LJUPDD, LJUPDT, LJUPDU, LJPGMN
        // Target columns: LJCHCO, LJCUST, LJJOB, LJCODE, LJENTDTE, LJPRCDTE, LJSTATUS, LJSTSDTE, LJCRTDATETIME, LJCRTU, LJUPDDATETIME, LJUPDU, LJPGMN

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("LJENTDTE", null);
            modified_values.put("LJPRCDTE", null);
            modified_values.put("LJSTSDTE", null);
            modified_values.put("LJCRTDATETIME", null);
            modified_values.put("LJUPDDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("LJENTDTE", makeDateTime(toLocalDate(newValues.get("LJENTDTE"))));
                modified_values.put("LJPRCDTE", makeDateTime(toLocalDate(newValues.get("LJPRCDTE"))));
                modified_values.put("LJSTSDTE", makeDateTime(toLocalDate(newValues.get("LJSTSDTE"))));
                modified_values.put("LJCRTDATETIME", makeDateTime(toLocalDate(newValues.get("LJCRTD")), toLocalTime(newValues.get("LJCRTT"))));
                modified_values.put("LJUPDDATETIME", makeDateTime(toLocalDate(newValues.get("LJUPDD")), toLocalTime(newValues.get("LJUPDT"))));
        } catch (Exception e) {
