 ...
 * Entity: KBMEFCOADD.FEHEST01 (DbMoto ReplicationID: 296)
 *
 * Decoded DbMoto field-mapping expressions:
 *   RCVDAT <- MakeDateTime([RCVDAT])
 *   REQDAT <- MakeDatetime([REQDAT])
 *   COMDAT <- MakeDateTime([COMDAT])
 *   SYSDATM <- MakeDateTime([SYSDAT],[SYSTIM])
 *
...
public class UDF_KBMEFCOADD_FEHEST01 {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("RCVDAT", null);
            modified_values.put("REQDAT", null);
            modified_values.put("COMDAT", null);
            modified_values.put("SYSDATM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("RCVDAT", makeDateTime(toLocalDate(newValues.get("RCVDAT"))));
                modified_values.put("REQDAT", makeDateTime(toLocalDate(newValues.get("REQDAT"))));
                modified_values.put("COMDAT", makeDateTime(toLocalDate(newValues.get("COMDAT"))));
                modified_values.put("SYSDATM", makeDateTime(toLocalDate(newValues.get("SYSDAT")), toBigDecimal(newValues.get("SYSTIM"))));
        } catch (Exception e) {
