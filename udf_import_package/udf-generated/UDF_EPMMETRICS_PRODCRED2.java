 ...
 * Entity: EPMMETRICS.PRODCRED2 (DbMoto ReplicationID: 201)
 *
 * Decoded DbMoto field-mapping expressions:
 *   TSDDTTR <- MakeDateTime([TSDTTR])
 *
 ...
 */
public class UDF_EPMMETRICS_PRODCRED2 {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SEQNUM, YEAR, PERIOD, WEEK, TSDTTR, TSCO, TSCODE, DOLRWC, TSSLSN, DASH, TSPN, TSTQTY, OSPRI, WTS$
        // Target columns: SEQNUM, FYEAR, FPERIOD, FWEEK, TSDDTTR, TSCO, TSCODE, DOLRWC, TSSLSN, DASH, TSPN, TSTQTY, OSPRI, WTS$

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("TSDDTTR", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("TSDDTTR", makeDateTime(toLocalDate(newValues.get("TSDTTR"))));
        } catch (Exception e) {
