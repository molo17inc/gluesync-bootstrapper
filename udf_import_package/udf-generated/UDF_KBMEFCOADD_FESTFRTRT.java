 ...
 * Entity: KBMEFCOADD.FESTFRTRT (DbMoto ReplicationID: 594)
 *
 * Decoded DbMoto field-mapping expressions:
 *   FRCRTDATETIME <- MakeDateTime([FRCRTDATE],[FRCRTTIME])
 *   FRUPDDATETIME <- MakeDateTime([FRUPDDATE],[FRUPDTIME])
 *
 ...
 */
public class UDF_KBMEFCOADD_FESTFRTRT {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: FRZIP3, FRSTATE, FRCFIMIN, FRCFIRAT, FRCFISP, FRCCMILE, FRCCMIN, FRCCL5C, FRCC5C, FRCC1M, FRCC2M, FRCC5M, FRCC10M, FRCC20M, FRCRTUSER, FRCRTDATE, FRCRTTIME, FRCRTPGM, FRUPDUSER, FRUPDDATE, FRUPDTIME, FRUPDPGM
        // Target columns: FRZIP3, FRSTATE, FRCFIMIN, FRCFIRAT, FRCFISP, FRCCMILE, FRCCMIN, FRCCL5C, FRCC5C, FRCC1M, FRCC2M, FRCC5M, FRCC10M, FRCC20M, FRCRTUSER, FRCRTDATETIME, FRCRTPGM, FRUPDUSER, FRUPDDATETIME, FRUPDPGM

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("FRCRTDATETIME", null);
            modified_values.put("FRUPDDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("FRCRTDATETIME", makeDateTime(toLocalDate(newValues.get("FRCRTDATE")), toLocalTime(newValues.get("FRCRTTIME"))));
                modified_values.put("FRUPDDATETIME", makeDateTime(toLocalDate(newValues.get("FRUPDDATE")), toLocalTime(newValues.get("FRUPDTIME"))));
        } catch (Exception e) {
