 ...
 * Entity: KBMEFCOADD.SLSAREAF (DbMoto ReplicationID: 707)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SACTDATETIME <- MakeDateTime([SACTDT],[SACTTM])
 *   SAUPDATETIME <- MakeDateTime([SAUPDT],[SAUPTM])
 *
 ...
 */
public class UDF_KBMEFCOADD_SLSAREAF {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SASLSAREA, SACO, SACTRY, SACNTY, SACITY, SASTAT, SAFIPS, SAZIP, SALAT, SALON, SAAC, SATZ, SAELEV, SACPOP, SAAREA, SACTDT, SACTTM, SACTID, SAUPDT, SAUPTM, SAUPID, SASEQ
        // Target columns: SASLSAREA, SACO, SACTRY, SACNTY, SACITY, SASTAT, SAFIPS, SAZIP, SALAT, SALON, SAAC, SATZ, SAELEV, SACPOP, SAAREA, SACTDATETIME, SACTID, SAUPDATETIME, SAUPID, SASEQ

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SACTDATETIME", null);
            modified_values.put("SAUPDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SACTDATETIME", makeDateTime(toLocalDate(newValues.get("SACTDT")), toLocalTime(newValues.get("SACTTM"))));
                modified_values.put("SAUPDATETIME", makeDateTime(toLocalDate(newValues.get("SAUPDT")), toLocalTime(newValues.get("SAUPTM"))));
        } catch (Exception e) {
