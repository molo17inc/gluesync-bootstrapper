 ...
 * Entity: ESPRODLIB.FSHIPBNO (DbMoto ReplicationID: 692)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SHIPDATE <- MakeDateTime([SHIPDT])
 *   SXCRTDATETIME <- MakeDateTime([SXCRTD],[SXCRTT])
 *   SXUPDDATETIME <- MakeDateTime([SXUPDD],[SXUPDT])
 *   SHDDATE1 <- MakeDateTime([SHDDT1])
 *   SHDDATE2 <- MakeDateTime([SHDDT2])
 *
...
public class UDF_ESPRODLIB_FSHIPBNO {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SHIPDATE", null);
            modified_values.put("SXCRTDATETIME", null);
            modified_values.put("SXUPDDATETIME", null);
            modified_values.put("SHDDATE1", null);
            modified_values.put("SHDDATE2", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SHIPDATE", makeDateTime(toLocalDate(newValues.get("SHIPDT"))));
                modified_values.put("SXCRTDATETIME", makeDateTime(toLocalDate(newValues.get("SXCRTD")), toLocalTime(newValues.get("SXCRTT"))));
                modified_values.put("SXUPDDATETIME", makeDateTime(toLocalDate(newValues.get("SXUPDD")), toLocalTime(newValues.get("SXUPDT"))));
                modified_values.put("SHDDATE1", makeDateTime(toLocalDate(newValues.get("SHDDT1"))));
                modified_values.put("SHDDATE2", makeDateTime(toLocalDate(newValues.get("SHDDT2"))));
        } catch (Exception e) {
