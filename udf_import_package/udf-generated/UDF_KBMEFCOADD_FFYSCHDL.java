 ...
 * Entity: KBMEFCOADD.FFYSCHDL (DbMoto ReplicationID: 341)
 *
 * Decoded DbMoto field-mapping expressions:
 *   WSDTESTMP <- MakeDateTime([WSDTESTMP])
 *
 ...
 */
public class UDF_KBMEFCOADD_FFYSCHDL {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: WSCO, WSFCCYY, WSFWEEK, WSDEPT, WSWRKCTR, WSRHOURS, WSFPO, WSPLO, WSCAPACITY, WSREL$, WSFPO$, WSPLO$, WSPLANHRS, WSPLANDLR, WSDTESTMP
        // Target columns: WSCO, WSFCCYY, WSFWEEK, WSDEPT, WSWRKCTR, WSRHOURS, WSFPO, WSPLO, WSCAPACITY, WSREL$, WSFPO$, WSPLO$, WSPLANHRS, WSPLANDLR, WSDTESTMP

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("WSDTESTMP", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("WSDTESTMP", makeDateTime(toLocalDate(newValues.get("WSDTESTMP"))));
        } catch (Exception e) {
