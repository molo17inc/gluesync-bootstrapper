 ...
 * Entity: KBMEFCOADD.REPAREAF (DbMoto ReplicationID: 706)
 *
 * Decoded DbMoto field-mapping expressions:
 *   RACTDATETIME <- MakeDateTime([RACTDT],[RACTTM])
 *   RAUPDATETIME <- MakeDateTime([RAUPDT],[RAUPTM])
 *
 ...
 */
public class UDF_KBMEFCOADD_REPAREAF {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: RACO, RASLSREP, RACODE, RADESC, RASEQ, RACTDT, RACTTM, RACTID, RAUPDT, RAUPTM, RAUPID
        // Target columns: RACO, RASLSREP, RACODE, RADESC, RASEQ, RACTDATETIME, RACTID, RAUPDATETIME, RAUPID

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("RACTDATETIME", null);
            modified_values.put("RAUPDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("RACTDATETIME", makeDateTime(toLocalDate(newValues.get("RACTDT")), toLocalTime(newValues.get("RACTTM"))));
                modified_values.put("RAUPDATETIME", makeDateTime(toLocalDate(newValues.get("RAUPDT")), toLocalTime(newValues.get("RAUPTM"))));
        } catch (Exception e) {
