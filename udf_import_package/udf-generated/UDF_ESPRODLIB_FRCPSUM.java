 ...
 * Entity: ESPRODLIB.FRCPSUM (DbMoto ReplicationID: 691)
 *
 * Decoded DbMoto field-mapping expressions:
 *   RSDATETIME <- MakeDateTime([RSDATE],[RSTIME])
 *   RCRBEGDATETIME <- MakeDateTime([RCRBEGD],[RCRBEGT])
 *   RCRENDDATETIME <- MakeDateTime([RCRENDD],[RCRENDT])
 *   RMCRTDATETIME <- MakeDateTime([RMCRTD],[RMCRTT])
 *   RMUPDDATETIME <- MakeDateTime([RMUPDD],[RMUPDT])
 *
 ...
 */
public class UDF_ESPRODLIB_FRCPSUM {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CONBR, ESTPRF, ESTYR, ESTNBR, ESTDSH, CYEAR, CNMBR, CDASH, PDCATE, SERIES, RDESC, TYPCOD, EMAPCD, ESRTCD, REF#, MARK, RQTY, RPCQTY, RLBALM, RALM$, RALM$C, RALMRF$, RALMRF$C, RLBBOA, RBOALM$, RBOALM$C, RBOALMRF$, RBOALMRF$C, RTLSFFIN, RTLFIN$, RTLFIN$C, RTLFINRF$, RTLFINRF$C, RSFFIN, RFIN$, RFIN$C, RFINRF$, RFINRF$C, RSFFN2, RFIN2$, RFIN2$C, RFIN2RF$, RFIN2RF$C, RSFGLS, RGLSWGT, RGLS$, RGLS$C, RGLSRF$, RGLSRF$C, RSFGLS1, RGLS1WGT, RGLS1$, RGLS1$C, RGLS1RF$, RGLS1RF$C, RSFGLS2, RGLS2WGT, RGLS2$, RGLS2$C, RGLS2RF$, RGLS2RF$C, RMISCWGT, RPURP$, RPURP$C, RPURPRF$, RPURPRF$C, RTLMHR, RTLMH$, RTLMH$C, RDL$, ROH$, RMU$, RGM$, RTLDOL, RTLCST, RTLDOLRF, RTLDOLRFC, RTLWGT, RTLSCA, RTLSCF, RTLSCS, RTLSCR, RFLDA, RFLDAW, RFLDA$, RFLDA$C, RFLDARF$, RFLDARF$C, RFLDB, RFLDBW, RFLDB$, RFLDB$C, RFLDBRF$, RFLDBRF$C, RFLDC, RFLDCW, RFLDC$, RFLDC$C, RFLDCRF$, RFLDCRF$C, REMULT, RMULT$, ROMULT, RTLOV$, RSDATE, RSTIME, RSUSER, RESPCT, ROVPCT, RTRAIL, CRATCHRG, RPROCESS, RMO, RPRCCAT, REPCT, ROPCT, RCRBEGD, RCRBEGT, RCRENDD, RCRENDT, RMCRTD, RMCRTT, RMCRTU, RMUPDD, RMUPDT, RMUPDU, RMPGMN
        // Target columns: CONBR, ESTPRF, ESTYR, ESTNBR, ESTDSH, CYEAR, CNMBR, CDASH, PDCATE, SERIES, RDESC, TYPCOD, EMAPCD, ESRTCD, REF#, MARK, RQTY, RPCQTY, RLBALM, RALM$, RALM$C, RALMRF$, RALMRF$C, RLBBOA, RBOALM$, RBOALM$C, RBOALMRF$, RBOALMRF$C, RTLSFFIN, RTLFIN$, RTLFIN$C, RTLFINRF$, RTLFINRF$C, RSFFIN, RFIN$, RFIN$C, RFINRF$, RFINRF$C, RSFFN2, RFIN2$, RFIN2$C, RFIN2RF$, RFIN2RF$C, RSFGLS, RGLSWGT, RGLS$, RGLS$C, RGLSRF$, RGLSRF$C, RSFGLS1, RGLS1WGT, RGLS1$, RGLS1$C, RGLS1RF$, RGLS1RF$C, RSFGLS2, RGLS2WGT, RGLS2$, RGLS2$C, RGLS2RF$, RGLS2RF$C, RMISCWGT, RPURP$, RPURP$C, RPURPRF$, RPURPRF$C, RTLMHR, RTLMH$, RTLMH$C, RDL$, ROH$, RMU$, RGM$, RTLDOL, RTLCST, RTLDOLRF, RTLDOLRFC, RTLWGT, RTLSCA, RTLSCF, RTLSCS, RTLSCR, RFLDA, RFLDAW, RFLDA$, RFLDA$C, RFLDARF$, RFLDARF$C, RFLDB, RFLDBW, RFLDB$, RFLDB$C, RFLDBRF$, RFLDBRF$C, RFLDC, RFLDCW, RFLDC$, RFLDC$C, RFLDCRF$, RFLDCRF$C, REMULT, RMULT$, ROMULT, RTLOV$, RSDATETIME, RSUSER, RESPCT, ROVPCT, RTRAIL, CRATCHRG, RPROCESS, RMO, RPRCCAT, REPCT, ROPCT, RCRBEGDATETIME, RCRENDDATETIME, RMCRTDATETIME, RMCRTU, RMUPDDATETIME, RMUPDU, RMPGMN

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("RSDATETIME", null);
            modified_values.put("RCRBEGDATETIME", null);
            modified_values.put("RCRENDDATETIME", null);
            modified_values.put("RMCRTDATETIME", null);
            modified_values.put("RMUPDDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("RSDATETIME", makeDateTime(toLocalDate(newValues.get("RSDATE")), toBigDecimal(newValues.get("RSTIME"))));
                modified_values.put("RCRBEGDATETIME", makeDateTime(toLocalDate(newValues.get("RCRBEGD")), toLocalTime(newValues.get("RCRBEGT"))));
                modified_values.put("RCRENDDATETIME", makeDateTime(toLocalDate(newValues.get("RCRENDD")), toLocalTime(newValues.get("RCRENDT"))));
                modified_values.put("RMCRTDATETIME", makeDateTime(toLocalDate(newValues.get("RMCRTD")), toLocalTime(newValues.get("RMCRTT"))));
                modified_values.put("RMUPDDATETIME", makeDateTime(toLocalDate(newValues.get("RMUPDD")), toLocalTime(newValues.get("RMUPDT"))));
        } catch (Exception e) {
