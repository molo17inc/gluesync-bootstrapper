 ...
 * Entity: KBMEFCOADD.FGDSBUL (DbMoto ReplicationID: 1139)
 *
 * Decoded DbMoto field-mapping expressions:
 *   BRDATE <- MakeDateTime([BRDATE])
 *
 ...
 */
public class UDF_KBMEFCOADD_FGDSBUL {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: BRUSER, BRTIME, BRTEXT, BRLOC, BRDLT, BRDATE, BRBARCD
        // Target columns: BRDLT, BRUSER, BRTIME, BRDATE, BRTEXT, BRBARCD, BRLOC

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("BRDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("BRDATE", makeDateTime(toLocalDate(newValues.get("BRDATE"))));
        } catch (Exception e) {
