 ...
 * Entity: KBMEFCOADD.FQADEFECT (DbMoto ReplicationID: 1034)
 *
 * Decoded DbMoto field-mapping expressions:
 *   QDCRTDATETIME <- LowDate(MakeDateTime([QDCRTDATE],[QDCRTTIME]))
 *
 ...
 */
public class UDF_KBMEFCOADD_FQADEFECT {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: QDCRTTIME, QDCRTDATE, QDCRTUSER, QDWONO, QDREASON, QD900DATE, QD1000DATE, QDCSGRP, QDWRKCTR, QD_R_QTY, QD_H_QTY, QD_O_QTY, QDSERIES, QDSUFFIX, QDITEM#, QDMARK, QD_MPS#, QDPART#, QDJOB#, QDSEQ#
        // Target columns: QDCRTDATETIME, QDCRTUSER, QDWONO, QDREASON, QD900DATE, QD1000DATE, QDCSGRP, QDWRKCTR, QD_R_QTY, QD_H_QTY, QD_O_QTY, QDSERIES, QDSUFFIX, QDITEM#, QDMARK, QD_MPS#, QDPART#, QDJOB#, QDSEQ#

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("QDCRTDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("QDCRTDATETIME", lowDate(makeDateTime(toLocalDate(newValues.get("QDCRTDATE")), toLocalTime(newValues.get("QDCRTTIME")))));
        } catch (Exception e) {
