 ...
 * Entity: KBM400MFG.FLPOSUM (DbMoto ReplicationID: 272)
 *
 * Decoded DbMoto field-mapping expressions:
 *   PODATE <- MakeDateTime("MMDDYY", [PODATE])
 *   PODTCR <- MakeDateTime([PODTCR])
 *   PODTED <- MakeDateTime([PODTED])
 *   PODTEF <- MakeDateTime("YYYYMMDD",[PODTEF])
 *   PODTEX <- MakeDateTime("YYYYMMDD",[PODTEX])
 *   PODTRL <- MakeDateTime([PODTRL])
 *   POEDATETM <- MakeDateTime(MakeDateTime([POEMM],[POEDD], [POEYY], [POECC]), [POETM])
 *   POLDRC <- MakeDateTime("YYYYMMDD",[POLDRC])
 *   POUDATETM <- MakeDateTime(MakeDateTime([POEMM],[POEDD], [POEYY], [POECC]), [POETM])
 *
...
public class UDF_KBM400MFG_FLPOSUM {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("PODATE", null);
            modified_values.put("PODTCR", null);
            modified_values.put("PODTED", null);
            modified_values.put("PODTEF", null);
            modified_values.put("PODTEX", null);
            modified_values.put("PODTRL", null);
            modified_values.put("POEDATETM", null);
            modified_values.put("POLDRC", null);
            modified_values.put("POUDATETM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("PODATE", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PODATE"))));
                modified_values.put("PODTCR", makeDateTime(toLocalDate(newValues.get("PODTCR"))));
                modified_values.put("PODTED", makeDateTime(toLocalDate(newValues.get("PODTED"))));
                modified_values.put("PODTEF", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("PODTEF"))));
                modified_values.put("PODTEX", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("PODTEX"))));
                modified_values.put("PODTRL", makeDateTime(toLocalDate(newValues.get("PODTRL"))));
                modified_values.put("POEDATETM", makeDateTime((LocalDate)makeDateTime(toBigDecimal(newValues.get("POEMM")), toBigDecimal(newValues.get("POEDD")), toBigDecimal(newValues.get("POEYY")), toBigDecimal(newValues.get("POECC"))), toBigDecimal(newValues.get("POETM"))));
                modified_values.put("POLDRC", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("POLDRC"))));
                modified_values.put("POUDATETM", makeDateTime((LocalDate)makeDateTime(toBigDecimal(newValues.get("POEMM")), toBigDecimal(newValues.get("POEDD")), toBigDecimal(newValues.get("POEYY")), toBigDecimal(newValues.get("POECC"))), toBigDecimal(newValues.get("POETM"))));
        } catch (Exception e) {
