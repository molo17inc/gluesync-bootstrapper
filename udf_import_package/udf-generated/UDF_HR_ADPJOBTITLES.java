 ...
 * Entity: HR.ADPJobTitles (DbMoto ReplicationID: 1106)
 *
 ...
 */
public class UDF_HR_ADPJOBTITLES {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: LastUpdatedDateTime, LastUpdatedUserName, BidType, FLSACode, Band, JobTitle, JobCode, RowID
        // Target columns: LUPDTS, LUPDUSER, BIDTYPE, FLSACODE, BAND, JOBTITLE, JOBCODE

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("JOBTITLE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("JOBTITLE", toUpperString(newValues.get("JobTitle")));
        } catch (Exception e) {
