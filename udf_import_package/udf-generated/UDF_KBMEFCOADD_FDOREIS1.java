 ...
 * Entity: KBMEFCOADD.FDOREIS1 (DbMoto ReplicationID: 294)
 *
 * Decoded DbMoto field-mapping expressions:
 *   Radatecrt <- MakeDateTime([RADATECRT],[RATIMECRT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FDOREIS1 {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: RAUSERID, RAPART#, RACO, RAQTY, RAREISWO, RAREASON, RADATECRT, RATIMECRT, RADO#, RAWOCRT, RAFORM#, RASEQ#
        // Target columns: Rauserid, Rapart#, Raco, Raqty, Rareiswo, Rareason, Radatecrt, Rado#, Rawocrt, Raform#, Raseq#

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("Radatecrt", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("Radatecrt", makeDateTime(toLocalDate(newValues.get("RADATECRT")), toLocalTime(newValues.get("RATIMECRT"))));
        } catch (Exception e) {
