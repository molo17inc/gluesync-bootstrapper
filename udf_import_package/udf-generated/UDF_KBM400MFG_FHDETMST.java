 ...
 * Generated by generate_udf_import_package.py on 2026-06-19 15:42:57
 * Entity: KBM400MFG.FHDETMST (DbMoto ReplicationID: 259)
 *
 * Decoded DbMoto field-mapping expressions:
 *   CDLSDATE <- MakeDateTime([CDLSMO],[CDLSDA],[CDLSYR],[CDLSCT])
 *   CDUDATE <- MakeDateTime(  MakeDateTime ( "MMDDYY",[CDUDTE]),  [CDUTIM] )
 *   CHODDATE <- LowDate(MakeDateTime([CHODMO], [CHODDA], [CHODYR], [CHODCT]))
 *   SACTDATE <- MakeDateTime([SACTMO], [SACTDA],[SACTYR],[SACTCT])
 *   SPRMDATE <- MakeDateTime([SPRMMO],[SPRMDA],[SPRMYR],[SPRMCT])
 *   SREQDATE <- MakeDateTime([SREQMO], [SREQDA], [SREQYR], [SREQCT])
 *
 ...
 */
public class UDF_KBM400MFG_FHDETMST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CDBO, CDBSTS, CDBTYP, CDCBUR, CDCCDL, CDCCDS, CDCCGL, CDCCRB, CDCFXM, CDCLAB, CDCMAT, CDCMTL, CDCODL, CDCODS, CDCOGL, CDCOM1, CDCOM2, CDCOM3, CDCONT, CDCOPR, CDCORB, CDCSPN, CDCUOM, CDCUS1, CDCUS2, CDCVBR, CDCVRM, CDC01, CDC02, CDC03, CDC04, CDC05, CDC06, CDC07, CDC08, CDC09, CDC10, CDDESC, CDDISC, CDDSCD, CDDTLD, CDEXMT, CDFLG1, CDFRCD, CDFRGT, CDFRIN, CDFSTC, CDFSTI, CDGLCD, CDHTYP, CDICDL, CDICDS, CDICGL, CDICRB, CDID, CDLINE, CDLSCT, CDLSDA, CDLSMO, CDLSYR, CDMDPR, CDMICD, CDMIIN, CDMISC, CDMTXP, CDNBSP, CDNOSD, CDORTP, CDPGRP, CDPN, CDPOST, CDPPDL, CDPPDS, CDPPGL, CDPPRB, CDPQDL, CDPQDS, CDPQGL, CDPQRB, CDPQTY, CDPRDM, CDPRIC, CDPRJ, CDPRSC, CDQTIN, CDQTLS, CDQTY, CDQTYR, CDQWSP, CDSCOD, CDSDPT, CDSPCT, CDSQTY, CDSTS, CDTAX, CDTINC, CDTODL, CDTODS, CDTOGL, CDTORB, CDTSDL, CDTSDS, CDTSGL, CDTSRB, CDTXCD, CDTXIM, CDTXIN, CDUDTE, CDUEVT, CDUPDM, CDUPGM, CDUPRI, CDUTGT, CDUTIM, CDUUSR, CDVATC, CDWHAR, CHACO, CHBTCN, CHCO, CHODCT, CHODDA, CHODMO, CHODYR, CHONO, SACTCT, SACTDA, SACTMO, SACTYR, SPRMCT, SPRMDA, SPRMMO, SPRMYR, SREQCT, SREQDA, SREQMO, SREQYR, CDDCO, CDASH
        // Target columns: CDBO, CDBSTS, CDBTYP, CDCBUR, CDCCDL, CDCCDS, CDCCGL, CDCCRB, CDCFXM, CDCLAB, CDCMAT, CDCMTL, CDCODL, CDCODS, CDCOGL, CDCOM1, CDCOM2, CDCOM3, CDCONT, CDCOPR, CDCORB, CDCSPN, CDCUOM, CDCUS1, CDCUS2, CDCVBR, CDCVRM, CDC01, CDC02, CDC03, CDC04, CDC05, CDC06, CDC07, CDC08, CDC09, CDC10, CDDESC, CDDISC, CDDSCD, CDDTLD, CDEXMT, CDFLG1, CDFRCD, CDFRGT, CDFRIN, CDFSTC, CDFSTI, CDGLCD, CDHTYP, CDICDL, CDICDS, CDICGL, CDICRB, CDID, CDLINE, CDLSDATE, CDMDPR, CDMICD, CDMIIN, CDMISC, CDMTXP, CDNBSP, CDNOSD, CDORTP, CDPGRP, CDPN, CDPOST, CDPPDL, CDPPDS, CDPPGL, CDPPRB, CDPQDL, CDPQDS, CDPQGL, CDPQRB, CDPQTY, CDPRDM, CDPRIC, CDPRJ, CDPRSC, CDQTIN, CDQTLS, CDQTY, CDQTYR, CDQWSP, CDSCOD, CDSDPT, CDSPCT, CDSQTY, CDSTS, CDTAX, CDTINC, CDTODL, CDTODS, CDTOGL, CDTORB, CDTSDL, CDTSDS, CDTSGL, CDTSRB, CDTXCD, CDTXIM, CDTXIN, CDUDATE, CDUEVT, CDUPDM, CDUPGM, CDUPRI, CDUTGT, CDUUSR, CDVATC, CDWHAR, CHACO, CHBTCN, CHCO, CHODDATE, CHONO, SACTDATE, SPRMDATE, SREQDATE, CDDCO, CDASH

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("CDLSDATE", null);
            modified_values.put("CDUDATE", null);
            modified_values.put("CHODDATE", null);
            modified_values.put("SACTDATE", null);
            modified_values.put("SPRMDATE", null);
            modified_values.put("SREQDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("CDLSDATE", makeDateTime(toBigDecimal(newValues.get("CDLSMO")), toBigDecimal(newValues.get("CDLSDA")), toBigDecimal(newValues.get("CDLSYR")), toBigDecimal(newValues.get("CDLSCT"))));
                modified_values.put("CDUDATE", makeDateTime((LocalDate)makeDateTime("MMDDYY", toBigDecimal(newValues.get("CDUDTE"))), toBigDecimal(newValues.get("CDUTIM"))));
                modified_values.put("CHODDATE", lowDate(makeDateTime(toBigDecimal(newValues.get("CHODMO")), toBigDecimal(newValues.get("CHODDA")), toBigDecimal(newValues.get("CHODYR")), toBigDecimal(newValues.get("CHODCT")))));
                ...
                modified_values.put("SPRMDATE", makeDateTime(toBigDecimal(newValues.get("SPRMMO")), toBigDecimal(newValues.get("SPRMDA")), toBigDecimal(newValues.get("SPRMYR")), toBigDecimal(newValues.get("SPRMCT"))));
                modified_values.put("SREQDATE", makeDateTime(toBigDecimal(newValues.get("SREQMO")), toBigDecimal(newValues.get("SREQDA")), toBigDecimal(newValues.get("SREQYR")), toBigDecimal(newValues.get("SREQCT"))));
        } catch (Exception e) {
