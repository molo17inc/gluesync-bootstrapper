 ...
 * Generated by generate_udf_import_package.py on 2026-06-19 15:43:03
 * Entity: KBMEFCOADD.FBCKLOGDWW (DbMoto ReplicationID: 1172)
 *
 * Decoded DbMoto field-mapping expressions:
 *   EDATEA <- MakeDateTime([EDATEA])
 *   BDATEA <- MakeDateTime([BDATEA])
 *
 ...
 */
public class UDF_KBMEFCOADD_FBCKLOGDWW {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: OSTATE, OSPREP, OSO, OSEQ, OREPN, OOREP#, OJOBN, ODYTSHP, ODASH, OCYTSHP, OCUSN, OCUS#, OBLJOBT, OAMNTPD, FSHDATA, FORDATA, ESTYR, ESTPRF, ESTNUM, ESTNBR, ESTDSH, EDATEA, BDATEA
        // Target columns: OSEQ, ESTDSH, ESTNBR, ESTYR, ESTPRF, ESTNUM, OAMNTPD, OCYTSHP, ODYTSHP, OSPREP, OBLJOBT, FSHDATA, FORDATA, ODASH, OJOBN, OSO, OSTATE, OCUSN, OCUS#, OREPN, OOREP#, EDATEA, BDATEA

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("EDATEA", null);
            modified_values.put("BDATEA", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("EDATEA", makeDateTime(toLocalDate(newValues.get("EDATEA"))));
                modified_values.put("BDATEA", makeDateTime(toLocalDate(newValues.get("BDATEA"))));
        } catch (Exception e) {
