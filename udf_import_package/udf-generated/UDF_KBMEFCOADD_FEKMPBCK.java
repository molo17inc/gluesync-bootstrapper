 ...
 * Entity: KBMEFCOADD.FEKMPBCK (DbMoto ReplicationID: 298)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DTECRT <- MakeDateTime([DTECRT])
 *   PMCRTDT <- MakeDateTime([PMCRTD],[PMCRTT])
 *   PMUPDDT <- MakeDateTime([PMUPDD],[PMUPDT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FEKMPBCK {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: IMCO, IMPN, OLDPN, DTECRT, JOBNBR, ECNNBR, PURGE, MATERL, PTWDTH, PTLGTH, FINISH, FAMSUB, FAMILY, CYEAR, CNUMBR, CDASH, SRIES1, SRIES2, SRIES3, SRIES4, SRIES5, SRIES6, SRIES7, SRIES8, SRIES9, SRIE10, SQTY1, SQTY2, SQTY3, SQTY4, SQTY5, SQTY6, SQTY7, SQTY8, SQTY9, SQTY10, DOLRWC, PMCRTD, PMUPDD, PMCRTT, PMUPDT, PMCRTU, PMUPDU, PMPGMN, PGFINDTL, PGFINMTH, PGSUBPNT, PGEDGES, PGSHAPE, PGCUTLNG, PGTOOLWC
        // Target columns: IMCO, IMPN, OLDPN, DTECRT, JOBNBR, ECNNBR, PURGE, MATERL, PTWDTH, PTLGTH, FINISH, FAMSUB, FAMILY, CYEAR, CNUMBR, CDASH, SRIES1, SRIES2, SRIES3, SRIES4, SRIES5, SRIES6, SRIES7, SRIES8, SRIES9, SRIE10, SQTY1, SQTY2, SQTY3, SQTY4, SQTY5, SQTY6, SQTY7, SQTY8, SQTY9, SQTY10, DOLRWC, PMCRTDT, PMUPDDT, PMCRTU, PMUPDU, PMPGMN

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DTECRT", null);
            modified_values.put("PMCRTDT", null);
            modified_values.put("PMUPDDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DTECRT", makeDateTime(toLocalDate(newValues.get("DTECRT"))));
                modified_values.put("PMCRTDT", makeDateTime(toLocalDate(newValues.get("PMCRTD")), toLocalTime(newValues.get("PMCRTT"))));
                modified_values.put("PMUPDDT", makeDateTime(toLocalDate(newValues.get("PMUPDD")), toLocalTime(newValues.get("PMUPDT"))));
        } catch (Exception e) {
