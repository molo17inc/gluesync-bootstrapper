 ...
 * Entity: KBM400MFG.FTSHPMTH (DbMoto ReplicationID: 701)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SMCTDATETIME <- MakeDateTime([SMCTDT],[SMCTTM])
 *   SMUPDATETIME <- MakeDateTime([SMUPDT],[SMUPTM])
 *
 ...
 */
public class UDF_KBM400MFG_FTSHPMTH {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SMCO, SMCODE, SMNAME, SMMODT, SMADRRS1, SMADRRS2, SMCITY, SMSTAT, SMZIP, SMPHONE, SMFAX, SMURL, SMACTIV, SMTYPE, SMCTDT, SMCTTM, SMCTID, SMUPDT, SMUPTM, SMUPID
        // Target columns: SMCO, SMCODE, SMNAME, SMMODT, SMADRRS1, SMADRRS2, SMCITY, SMSTAT, SMZIP, SMPHONE, SMFAX, SMURL, SMACTIV, SMTYPE, SMCTDATETIME, SMCTID, SMUPDATETIME, SMUPID

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SMCTDATETIME", null);
            modified_values.put("SMUPDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SMCTDATETIME", makeDateTime(toLocalDate(newValues.get("SMCTDT")), toLocalTime(newValues.get("SMCTTM"))));
                modified_values.put("SMUPDATETIME", makeDateTime(toLocalDate(newValues.get("SMUPDT")), toLocalTime(newValues.get("SMUPTM"))));
        } catch (Exception e) {
