 ...
 * Entity: KBM400MFG.FTMDAY (DbMoto ReplicationID: 284)
 *
 * Decoded DbMoto field-mapping expressions:
 *   MDCALDATE <- MakeDateTime("MMDDYY",[MDCALD],[MDCACC])
 *   MDCADD <- MakeDateTime([MDCADD])
 *
 ...
 */
public class UDF_KBM400MFG_FTMDAY {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: MDAY, MDCAL, MDCALD, MDAYWK, MDWRK, MDCO, MDCACC, MDCADD
        // Target columns: MDAY, MDCAL, MDCALDATE, MDAYWK, MDWRK, MDCO, MDCADD

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("MDCALDATE", null);
            modified_values.put("MDCADD", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("MDCALDATE", makeDateTime("MMDDYY", toBigDecimal(newValues.get("MDCALD")), toBigDecimal(newValues.get("MDCACC"))));
                modified_values.put("MDCADD", makeDateTime(toLocalDate(newValues.get("MDCADD"))));
        } catch (Exception e) {
