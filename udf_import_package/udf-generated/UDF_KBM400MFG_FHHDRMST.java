 ...
 * Entity: KBM400MFG.FHHDRMST (DbMoto ReplicationID: 260)
 *
 * Decoded DbMoto field-mapping expressions:
 *   CHDLSP <- MakeDateTime("MMDDYY",[CHDLSP])
 *   CHDTDATE <- MakeDateTime("MMDDYY",[CHDTLA], [CHDTCC])
 *   CHODDATE <- MakeDateTime([CHODMO],[CHODDA],[CHODYR],[CHODCT])
 *   CHORDATE <- MakeDateTime([CHORMO],[CHORDA],[CHORYR],[CHORCT])
 *   CHUDATE <- MakeDateTime(MakeDateTime("YYYYMMDD",[CHUDTE]), [CHUTIM])
 *
 ...
 */
public class UDF_KBM400MFG_FHHDRMST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CHACO, CHBAC, CHBCCD, CHBCOT, CHBCTC, CHBFAX, CHBLCL, CHBPHO, CHBTCN, CHBTYP, CHCM01, CHCM02, CHCM03, CHCM04, CHCM05, CHCM06, CHCM07, CHCM08, CHCM09, CHCM10, CHCO, CHCRTY, CHCSPO, CHCURR, CHCVAT, CHDLSP, CHDTCC, CHDTLA, CHERTS, CHFCEX, CHFOB, CHGFLG, CHGLCD, CHGORD, CHNO, CHNOAK, CHNOIV, CHNOSD, CHODCT, CHODDA, CHODMO, CHODYR, CHONO, CHORCT, CHORDA, CHORMO, CHORYR, CHPQFL, CHPQFR, CHPRJ, CHREGN, CHSAC, CHSCCD, CHSCOT, CHSCTC, CHSFAX, CHSMTX, CHSORT, CHSPHO, CHSSEQ, CHSTAT, CHSTCN, CHSTS, CHTER, CHTODT, CHTOFL, CHTOFR, CHTOST, CHUDTE, CHUEVT, CHUPGM, CHUTGT, CHUTIM, CHUUSR, CHWHAR, CMBAD1, CMBAD2, CMBAD3, CMBAD4, CMBAD5, CMBEML, CMBNAM, CMBOSP, CMBZIP, CMDISC, CMDSCD, CMPRON, CMPTIV, CMPTSP, CMSAD1, CMSAD2, CMSAD3, CMSAD4, CMSAD5, CMSCOD, CMSEML, CMSLSM, CMSNAM, CMSPCN, CMSPCT, CMSPMT, CMSZIP, CMTAX1, CMTAX2, CMTAX3, CMTAX4, CMTRMS, CUSTFC, CMDDCO, CHODCN
        // Target columns: CHACO, CHBAC, CHBCCD, CHBCOT, CHBCTC, CHBFAX, CHBLCL, CHBPHO, CHBTCN, CHBTYP, CHCM01, CHCM02, CHCM03, CHCM04, CHCM05, CHCM06, CHCM07, CHCM08, CHCM09, CHCM10, CHCO, CHCRTY, CHCSPO, CHCURR, CHCVAT, CHDLSP, CHDTDATE, CHERTS, CHFCEX, CHFOB, CHGFLG, CHGLCD, CHGORD, CHNO, CHNOAK, CHNOIV, CHNOSD, CHODDATE, CHONO, CHORDATE, CHPQFL, CHPQFR, CHPRJ, CHREGN, CHSAC, CHSCCD, CHSCOT, CHSCTC, CHSFAX, CHSMTX, CHSORT, CHSPHO, CHSSEQ, CHSTAT, CHSTCN, CHSTS, CHTER, CHTODT, CHTOFL, CHTOFR, CHTOST, CHUDATE, CHUEVT, CHUPGM, CHUTGT, CHUTIM, CHUUSR, CHWHAR, CMBAD1, CMBAD2, CMBAD3, CMBAD4, CMBAD5, CMBEML, CMBNAM, CMBOSP, CMBZIP, CMDISC, CMDSCD, CMPRON, CMPTIV, CMPTSP, CMSAD1, CMSAD2, CMSAD3, CMSAD4, CMSAD5, CMSCOD, CMSEML, CMSLSM, CMSNAM, CMSPCN, CMSPCT, CMSPMT, CMSZIP, CMTAX1, CMTAX2, CMTAX3, CMTAX4, CMTRMS, CUSTFC, CMDDCO, CHODCN

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("CHDLSP", null);
            modified_values.put("CHDTDATE", null);
            modified_values.put("CHODDATE", null);
            modified_values.put("CHORDATE", null);
            modified_values.put("CHUDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("CHDLSP", makeDateTime("MMDDYY", toBigDecimal(newValues.get("CHDLSP"))));
                modified_values.put("CHDTDATE", makeDateTime("MMDDYY", toBigDecimal(newValues.get("CHDTLA")), toBigDecimal(newValues.get("CHDTCC"))));
                ...
                modified_values.put("CHORDATE", makeDateTime(toBigDecimal(newValues.get("CHORMO")), toBigDecimal(newValues.get("CHORDA")), toBigDecimal(newValues.get("CHORYR")), toBigDecimal(newValues.get("CHORCT"))));
                modified_values.put("CHUDATE", makeDateTime((LocalDate)makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("CHUDTE"))), toBigDecimal(newValues.get("CHUTIM"))));
        } catch (Exception e) {
