 ...
 * Entity: KBMEFCOADD.FSENGDSH (DbMoto ReplicationID: 325)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SEDCrtDtTm <- MakeDateTime([SEDCRTDT],[SEDCRTTM])
 *   SEDUpdDtTm <- MakeDateTime([SEDUPDDT],[SEDUPDTM])
 *
 ...
 */
public class UDF_KBMEFCOADD_FSENGDSH {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SECO, SESLSORD, SEDASH, SESCHTYPE, SESCHNAME, SESCHNUM, SESCHSEQ, SESTATUS, SEDCUSER, SEDCPGMN, SEDCRTDT, SEDCRTTM, SEDUUSER, SEDUPGMN, SEDUPDDT, SEDUPDTM
        // Target columns: SECo, SESlsOrd, SEDash, SESchType, SESchName, SESchNum, SESchSeq, SEStatus, SEDCUser, SEDCPgmn, SEDCrtDtTm, SEDUUser, SEDUPgmn, SEDUpdDtTm

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SEDCrtDtTm", null);
            modified_values.put("SEDUpdDtTm", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SEDCrtDtTm", makeDateTime(toLocalDate(newValues.get("SEDCRTDT")), toLocalTime(newValues.get("SEDCRTTM"))));
                modified_values.put("SEDUpdDtTm", makeDateTime(toLocalDate(newValues.get("SEDUPDDT")), toLocalTime(newValues.get("SEDUPDTM"))));
        } catch (Exception e) {
