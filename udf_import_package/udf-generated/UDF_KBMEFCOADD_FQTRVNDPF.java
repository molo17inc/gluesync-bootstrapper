 ...
 * Entity: KBMEFCOADD.FQTRVNDPF (DbMoto ReplicationID: 320)
 *
 * Decoded DbMoto field-mapping expressions:
 *   VPCRTDTETM <- MakeDateTime([VPCRTDTE],[VPCRTTME])
 *   VPCHGDTETM <- MakeDateTime([VPCHGDTE],[VPCHGTME])
 *
 ...
 */
public class UDF_KBMEFCOADD_FQTRVNDPF {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: VPVENDOR, VPBUYER, VPYEAR, VPQTR, VPPXCTN, VPRSPON, VPNEWPROD, VPFAILURE, VPSRVPART, VPWRRNTY, VPCOMMNT, VPCRTUSER, VPCHGUSER, VPCRTDTE, VPCHGDTE, VPCRTTME, VPCHGTME
        // Target columns: VPVENDOR, VPBUYER, VPYEAR, VPQTR, VPPXCTN, VPRSPON, VPNEWPROD, VPFAILURE, VPSRVPART, VPWRRNTY, VPCOMMNT, VPCRTUSER, VPCHGUSER, VPCRTDTETM, VPCHGDTETM

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("VPCRTDTETM", null);
            modified_values.put("VPCHGDTETM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("VPCRTDTETM", makeDateTime(toLocalDate(newValues.get("VPCRTDTE")), toLocalTime(newValues.get("VPCRTTME"))));
                modified_values.put("VPCHGDTETM", makeDateTime(toLocalDate(newValues.get("VPCHGDTE")), toLocalTime(newValues.get("VPCHGTME"))));
        } catch (Exception e) {
