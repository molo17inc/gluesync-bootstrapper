 ...
 * Entity: KBM400D011.GLDATE (DbMoto ReplicationID: 251)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DTEREFDATE <- MakeDateTime("MMDDYY",[DTEREF])
 *   FYEAR <- Int([FISCAL]/100)
 *
 ...
 */
public class UDF_KBM400D011_GLDATE {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: AUDOPR, AUDTIM, CDEEND, CENTRY, DAYWK, DAYYR, DTEREF, FISCAL, FRQDED, FSCLCC, FULLDT, PERIOD, QTR, WEEK, YEAR, FULDTD
        // Target columns: AUDOPR, AUDTIM, CDEEND, DAYYR, DTEREFDATE, FISCAL, FRQDED, PERIOD, QTR, WEEK, FYEAR, FULLDTYEAR, FULLDTDAY, FULLDTMONTH, FULDTD, YEAR, FULLDT, FSCLCC, CENTRY, DAYWK

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DTEREFDATE", null);
            modified_values.put("FYEAR", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DTEREFDATE", makeDateTime("MMDDYY", toBigDecimal(newValues.get("DTEREF"))));
                modified_values.put("FYEAR", intDivide(toBigDecimal(newValues.get("FISCAL")), new BigDecimal(100)));
        } catch (Exception e) {
