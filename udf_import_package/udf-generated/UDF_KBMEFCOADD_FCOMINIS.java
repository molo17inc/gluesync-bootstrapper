 ...
 * Entity: KBMEFCOADD.FCOMINIS (DbMoto ReplicationID: 703)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DATEOP <- MakeDateTime([DATEOP])
 *   DATECL <- MakeDateTime([DATECL])
 *   FCCRTDATETIME <- MakeDateTime([FCCRTD],[FCCRTT])
 *   FCUPDDATETIME <- MakeDateTime([FCUPDD],[FCUPDT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FCOMINIS {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SEQUENCE, OWNER, CONTROLCO, SLCODE, PDSN, STATUS, CONAME, COADD1, COADD2, COADD3, COSTAT, COZIP, PHONE, FAX, CONTACT, HOURS, DATEOP, DATECL, LMWARE1, LMCODE1, LMWARE2, LMCODE2, LMWARE3, LMCODE3, LMWARE4, LMCODE4, FCCRTD, FCUPDD, FCCRTT, FCUPDT, FCCRTU, FCUPDU, FCPGMN
        // Target columns: SEQUENCE, OWNER, CONTROLCO, SLCODE, PDSN, STATUS, CONAME, COADD1, COADD2, COADD3, COSTAT, COZIP, PHONE, FAX, CONTACT, HOURS, DATEOP, DATECL, LMWARE1, LMCODE1, LMWARE2, LMCODE2, LMWARE3, LMCODE3, LMWARE4, LMCODE4, FCCRTDATETIME, FCUPDDATETIME, FCCRTU, FCUPDU, FCPGMN

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DATEOP", null);
            modified_values.put("DATECL", null);
            modified_values.put("FCCRTDATETIME", null);
            modified_values.put("FCUPDDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DATEOP", makeDateTime(toLocalDate(newValues.get("DATEOP"))));
                modified_values.put("DATECL", makeDateTime(toLocalDate(newValues.get("DATECL"))));
                modified_values.put("FCCRTDATETIME", makeDateTime(toLocalDate(newValues.get("FCCRTD")), toLocalTime(newValues.get("FCCRTT"))));
                modified_values.put("FCUPDDATETIME", makeDateTime(toLocalDate(newValues.get("FCUPDD")), toLocalTime(newValues.get("FCUPDT"))));
        } catch (Exception e) {
