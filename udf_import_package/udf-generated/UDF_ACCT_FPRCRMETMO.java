 ...
 * Entity: ACCT.FPRCRMETMO (DbMoto ReplicationID: 1160)
 *
 * Decoded DbMoto field-mapping expressions:
 *   PCDTTR <- MakeDateTime([PCDTTR])
 *
 ...
 */
public class UDF_ACCT_FPRCRMETMO {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: USEDRTV, STRTPER, STRTORD, STRTFTPER, STRTFTORD, SCRN_TYPES, QTYORD, PCWC, PCTQTY, PCTIME, PCSTRTQTY, PCSTRTFEET, PCSLSN, PCREV$, PCPSF, PCPN, PCFDQTY, PCFDFEET, PCDTTR, PCCOST, PCCO, PCASF, PCALLB, PAINTPER, PAINTORD, LBSPER, LBSORD, FINTYPE, FDQTYPER, FDQTYORD, FDFEETPER, FDFEETORD, ANODPER, ANODORD, PCUSEQ, PCTSSESN, YEAR, PERIOD
        // Target columns: PCUSEQ, PCTSSESN, SCRN_TYPES, STRTFTPER, STRTFTORD, STRTPER, STRTORD, FDFEETPER, FDFEETORD, FDQTYPER, FDQTYORD, ANODPER, ANODORD, PAINTPER, PAINTORD, LBSPER, LBSORD, QTYORD, FINTYPE, USEDRTV, PCSTRTFEET, PCSTRTQTY, PCFDFEET, PCFDQTY, PCASF, PCPSF, PCALLB, PCTQTY, PCPN, PCTIME, PCDTTR, PCSLSN, PCCOST, PCREV$, PCWC, PCCO, YEAR, PERIOD

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("PCDTTR", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("PCDTTR", makeDateTime(toLocalDate(newValues.get("PCDTTR"))));
        } catch (Exception e) {
