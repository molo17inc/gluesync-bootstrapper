 ...
 * Entity: KBMEFCOADD.FWARRANT (DbMoto ReplicationID: 648)
 *
 * Decoded DbMoto field-mapping expressions:
 *   WISSDATE <- MakeDateTime([WISSDT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FWARRANT {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: WCO, WJOB, WCUSNU, WISSDT, WGLASS, WWINDO, WSTRFR, WCURTW, WROTOS, WFINIS, WPRINT, WTIMES, WUSER, WTIMEU, WUSERU, WFPGMN, WMDDCO, WDOORS, WCRDPASS
        // Target columns: WCO, WJOB, WCUSNU, WISSDATE, WGLASS, WWINDO, WSTRFR, WCURTW, WROTOS, WFINIS, WPRINT, WTIMES, WUSER, WTIMEU, WUSERU, WFPGMN, WMDDCO, WDOORS, WCRDPASS

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("WISSDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("WISSDATE", makeDateTime(toLocalDate(newValues.get("WISSDT"))));
        } catch (Exception e) {
