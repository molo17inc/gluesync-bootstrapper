 ...
 * Entity: INTRANET.PAINT_INVENTORY (DbMoto ReplicationID: 223)
 *
 * Decoded DbMoto field-mapping expressions:
 *   TIME_STAMP <- MakeDateTime([TIME_STAMP])
 *
 ...
 */
public class UDF_INTRANET_PAINT_INVENTORY {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: INVENTORY_ID, COLOR_NAME, COLOR_CODE, COMPANY_NUM, TIME_STAMP
        // Target columns: INVENTORY_ID, COLOR_NAME, COLOR_CODE, COMPANY_NUM, TIME_STAMP

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("TIME_STAMP", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("TIME_STAMP", makeDateTime(toLocalDate(newValues.get("TIME_STAMP"))));
        } catch (Exception e) {
