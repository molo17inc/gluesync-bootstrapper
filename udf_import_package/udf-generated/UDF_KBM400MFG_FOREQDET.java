 ...
 * Entity: KBM400MFG.FOREQDET (DbMoto ReplicationID: 289)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DTRDATE2 <- MakeDateTime("YYMMDD",[DTRDAT])
 *
 ...
 */
public class UDF_KBM400MFG_FOREQDET {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CONO, MGCNO, WCNO, DEPTNO, DTRDAT, DTORDT, DTORDR, DTIMPN, DTQTY, DTLREQ, DTMREQ, DTOPNO, DTALTC, DTAVAL
        // Target columns: RECORDID, CONO, MGCNO, WCNO, DEPTNO, DTRDATE, DTRDATE2, DTORDT, DTORDR, DTIMPN, DTQTY, DTLREQ, DTMREQ, DTOPNO, DTALTC, DTAVAL

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DTRDATE2", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DTRDATE2", makeDateTime("YYMMDD", toBigDecimal(newValues.get("DTRDAT"))));
