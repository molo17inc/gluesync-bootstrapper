 ...
 * Entity: ESPRODLIB.FFINCSTAL (DbMoto ReplicationID: 1086)
 *
 * Decoded DbMoto field-mapping expressions:
 *   RDUPTDT <- MakeDateTime([RDUPTD], [RDUPTT])
 ...
 */
public class UDF_ESPRODLIB_FFINCSTAL {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: RDPGMN, RDUPTU, RDUPTT, RDUPTD, RDCRTU, RDCRTT, RDCRTD, FINFCTAND, FINFCTPNT, FINEXT
        // Target columns: RDPGMN, RDUPTU, RDUPTDT, RDCRTU, RDCRTDT, FINFCTAND, FINFCTPNT, FINEXT

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("RDUPTDT", null);
            modified_values.put("RDCRTDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("RDUPTDT", makeDateTime(toLocalDate(newValues.get("RDUPTD")), toLocalTime(newValues.get("RDUPTT"))));
