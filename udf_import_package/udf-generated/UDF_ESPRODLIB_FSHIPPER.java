 ...
 * Entity: ESPRODLIB.FSHIPPER (DbMoto ReplicationID: 694)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SHINDATETIME <- MakeDateTime([SHINDT],[SHINTM])
 *   SHUPDATETIME <- MakeDateTime([SHUPDT],[SHUPTM])
 *   BWCRTDATETIME <- MakeDateTime([BWCRTD],[BWCRTT])
 *   BWUPDDATETIME <- MakeDateTime([BWUPDD],[BWUPDT])
 *
 ...
 */
public class UDF_ESPRODLIB_FSHIPPER {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SHYR, SHNBR, SHDSH, SHMARK, SHPN, SHPMRK, SHITEM, SHQTY, SHHT, SHWD, SHSZAP, SHINDT, SHINTM, SHINUR, SHUPDT, SHUPTM, SHUPUR, SHTYPE, SHFNTP, SHFNCS, SHFNCR, SHFNMS, SHIFTP, SHIFCS, SHIFCR, SHIFMS, SHWC, SHDSC1, SHDSC2, SHDSC3, SHPCAT, SHSRC, SHSER, SHSYS, FITEM#, FFS#, FFE, BWCO, BWCRTD, BWUPDD, BWCRTT, BWUPDT, BWCRTU, BWUPDU, BWPGMN, SINVPN, SINVWO, SINVCO, SMPSPN, SMPSWO, SMPSCO
        // Target columns: SHYR, SHNBR, SHDSH, SHMARK, SHPN, SHPMRK, SHITEM, SHQTY, SHHT, SHWD, SHSZAP, SHINDATETIME, SHINUR, SHUPDATETIME, SHUPUR, SHTYPE, SHFNTP, SHFNCS, SHFNCR, SHFNMS, SHIFTP, SHIFCS, SHIFCR, SHIFMS, SHWC, SHDSC1, SHDSC2, SHDSC3, SHPCAT, SHSRC, SHSER, SHSYS, FITEM#, FFS#, FFE, BWCO, BWCRTDATETIME, BWUPDDATETIME, BWCRTU, BWUPDU, BWPGMN, SINVPN, SINVWO, SINVCO, SMPSPN, SMPSWO, SMPSCO

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SHINDATETIME", null);
            modified_values.put("SHUPDATETIME", null);
            modified_values.put("BWCRTDATETIME", null);
            modified_values.put("BWUPDDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SHINDATETIME", makeDateTime(toLocalDate(newValues.get("SHINDT")), toBigDecimal(newValues.get("SHINTM"))));
                modified_values.put("SHUPDATETIME", makeDateTime(toLocalDate(newValues.get("SHUPDT")), toBigDecimal(newValues.get("SHUPTM"))));
                modified_values.put("BWCRTDATETIME", makeDateTime(toLocalDate(newValues.get("BWCRTD")), toLocalTime(newValues.get("BWCRTT"))));
                modified_values.put("BWUPDDATETIME", makeDateTime(toLocalDate(newValues.get("BWUPDD")), toLocalTime(newValues.get("BWUPDT"))));
        } catch (Exception e) {
