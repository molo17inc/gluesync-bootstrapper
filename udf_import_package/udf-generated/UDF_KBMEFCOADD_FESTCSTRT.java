 ...
 * Entity: KBMEFCOADD.FESTCSTRT (DbMoto ReplicationID: 593)
 *
 * Decoded DbMoto field-mapping expressions:
 *   CRCRTDATETIME <- MakeDateTime([CRCRTDATE],[CRCRTTIME])
 *   CRUPDDATETIME <- MakeDateTime([CRUPDDATE],[CRUPDTIME])
 *
 ...
 */
public class UDF_KBMEFCOADD_FESTCSTRT {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CRCODE, CRDESC, CRNUM, CRCRTUSER, CRCRTDATE, CRCRTTIME, CRCRTPGM, CRUPDUSER, CRUPDDATE, CRUPDTIME, CRUPDPGM
        // Target columns: CRCODE, CRDESC, CRNUM, CRCRTUSER, CRCRTDATETIME, CRCRTPGM, CRUPDUSER, CRUPDDATETIME, CRUPDPGM

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("CRCRTDATETIME", null);
            modified_values.put("CRUPDDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("CRCRTDATETIME", makeDateTime(toLocalDate(newValues.get("CRCRTDATE")), toLocalTime(newValues.get("CRCRTTIME"))));
                modified_values.put("CRUPDDATETIME", makeDateTime(toLocalDate(newValues.get("CRUPDDATE")), toLocalTime(newValues.get("CRUPDTIME"))));
        } catch (Exception e) {
