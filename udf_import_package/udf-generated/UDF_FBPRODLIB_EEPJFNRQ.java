 ...
 * Entity: FBPRODLIB.EEPJFNRQ (DbMoto ReplicationID: 677)
 *
 * Decoded DbMoto field-mapping expressions:
 *   FRCRTDATETIME <- MakeDateTime([ODATE],[FRCRTT])
 *   FRUPDDATETIME <- MakeDateTime([NDATE],[FRUPDT])
 *
...
public class UDF_FBPRODLIB_EEPJFNRQ {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        try {
                modified_values.put("FRCRTDATETIME", makeDateTime(toLocalDate(newValues.get("ODATE")), toLocalTime(newValues.get("FRCRTT"))));
                modified_values.put("FRUPDDATETIME", makeDateTime(toLocalDate(newValues.get("NDATE")), toLocalTime(newValues.get("FRUPDT"))));
        } catch (Exception e) {
