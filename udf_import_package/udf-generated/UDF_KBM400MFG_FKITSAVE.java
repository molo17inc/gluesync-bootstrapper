 ...
 * Entity: KBM400MFG.FKITSAVE (DbMoto ReplicationID: 267)
 *
 * Decoded DbMoto field-mapping expressions:
 *   TSDCNT <- MakeDateTime("MMDDYY",[TSDCNT])
 *   TSDTCC <- MakeDateTime([TSDTCC])
 *   TSDTCN <- MakeDateTime([TSDTCN])
 *   TSDTDU <- MakeDateTime([TSDTDU])
 *   TSDTTR <- MakeDateTime([TSDTTR])
 *   TSDUDATE <- MakeDateTime("MMDDYY",[TSDUDT],[TSDUCC])
 *   TSDATETIME <- LowDate(MakeDateTime(  MakeDateTime("CYYMMDD",[TSDATE]),[TSTIME]))
 *
...
public class UDF_KBM400MFG_FKITSAVE {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("TSDCNT", null);
            modified_values.put("TSDTCC", null);
            modified_values.put("TSDTCN", null);
            modified_values.put("TSDTDU", null);
            modified_values.put("TSDTTR", null);
            modified_values.put("TSDUDATE", null);
            modified_values.put("TSDATETIME", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("TSDCNT", makeDateTime("MMDDYY", toBigDecimal(newValues.get("TSDCNT"))));
                modified_values.put("TSDTCC", makeDateTime(toLocalDate(newValues.get("TSDTCC"))));
                modified_values.put("TSDTCN", makeDateTime(toLocalDate(newValues.get("TSDTCN"))));
                modified_values.put("TSDTDU", makeDateTime(toLocalDate(newValues.get("TSDTDU"))));
                modified_values.put("TSDTTR", makeDateTime(toLocalDate(newValues.get("TSDTTR"))));
                modified_values.put("TSDUDATE", makeDateTime("MMDDYY", toBigDecimal(newValues.get("TSDUDT")), toBigDecimal(newValues.get("TSDUCC"))));
                modified_values.put("TSDATETIME", lowDate(makeDateTime((LocalDate)makeDateTime("CYYMMDD", toBigDecimal(newValues.get("TSDATE"))), toBigDecimal(newValues.get("TSTIME")))));
