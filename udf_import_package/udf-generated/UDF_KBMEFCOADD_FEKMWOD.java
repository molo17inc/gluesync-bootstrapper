 ...
 * Entity: KBMEFCOADD.FEKMWOD (DbMoto ReplicationID: 299)
 *
 * Decoded DbMoto field-mapping expressions:
 *   WDSTDTE <- MakeDateTime("YY",[WDSTMM],[WDSTDD],[WDSTYY])
 *   WDACDTE <- MakeDateTime("YY",[WDACMM],[WDACDD],[WDACYY])
 *   WDDUDTE <- MakeDateTime("YY",[WDDUMM],[WDDUDD],[WDDUYY])
 *   WDCRTDTM <- MakeDateTime([WDCRTD],[WDCRTT])
 *   WDUPDDTM <- MakeDateTime([WDUPDD],[WDUPDT])
 *   WDUDTETM <- MakeDateTime(MakeDateTime("YYYYMMDD",[WDUDTE]), [WDUTIM])
 *
...
public class UDF_KBMEFCOADD_FEKMWOD {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("WDSTDTE", null);
            modified_values.put("WDACDTE", null);
            modified_values.put("WDDUDTE", null);
            modified_values.put("WDCRTDTM", null);
            modified_values.put("WDUPDDTM", null);
            modified_values.put("WDUDTETM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("WDSTDTE", makeDateTime("YY", toBigDecimal(newValues.get("WDSTMM")), toBigDecimal(newValues.get("WDSTDD")), toBigDecimal(newValues.get("WDSTYY"))));
                modified_values.put("WDACDTE", makeDateTime("YY", toBigDecimal(newValues.get("WDACMM")), toBigDecimal(newValues.get("WDACDD")), toBigDecimal(newValues.get("WDACYY"))));
                modified_values.put("WDDUDTE", makeDateTime("YY", toBigDecimal(newValues.get("WDDUMM")), toBigDecimal(newValues.get("WDDUDD")), toBigDecimal(newValues.get("WDDUYY"))));
                modified_values.put("WDCRTDTM", makeDateTime(toLocalDate(newValues.get("WDCRTD")), toLocalTime(newValues.get("WDCRTT"))));
                modified_values.put("WDUPDDTM", makeDateTime(toLocalDate(newValues.get("WDUPDD")), toLocalTime(newValues.get("WDUPDT"))));
                modified_values.put("WDUDTETM", makeDateTime((LocalDate)makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("WDUDTE"))), toBigDecimal(newValues.get("WDUTIM"))));
        } catch (Exception e) {
