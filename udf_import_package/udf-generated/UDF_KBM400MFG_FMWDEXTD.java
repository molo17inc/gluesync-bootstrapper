 ...
 * Entity: KBM400MFG.FMWDEXTD (DbMoto ReplicationID: 276)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DUPDDT <- MakeDateTime([DUPDDT],[DUPDTT])
 *
 ...
 */
public class UDF_KBM400MFG_FMWDEXTD {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: RTCO, WOWONO, DEOPNO, DELINE, DESUBL, DEDESC, DEDATE, DUPDDT, DUPDTT
        // Target columns: RTCO, WOWONO, DEOPNO, DELINE, DESUBL, DEDESC, DEDATE, DUPDDT

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DUPDDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DUPDDT", makeDateTime(toLocalDate(newValues.get("DUPDDT")), toLocalTime(newValues.get("DUPDTT"))));
        } catch (Exception e) {
