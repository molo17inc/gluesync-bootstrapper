 ...
 * Entity: KBMEFCOADD.FFSJOBFX (DbMoto ReplicationID: 309)
 *
 * Decoded DbMoto field-mapping expressions:
 *   FXCRTD <- MakeDateTime([FXCRTD],[FXCRTT])
 *   FXUPDD <- MakeDateTime([FXUPDD],[FXUPDT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FFSJOBFX {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: FXFIXCO#, FXFIXSO#, FXPRBCO#, FXPRBJOB, FXPRBJB5, FXPRBDSH, FXFSPRB#, FXMLTPRB, FXCRTD, FXCRTT, FXCRTU, FXCRTP, FXUPDD, FXUPDT, FXUPDU, FXUPDP
        // Target columns: FXFIXCO#, FXFIXSO#, FXPRBCO#, FXPRBJOB, FXPRBJB5, FXPRBDSH, FXFSPRB#, FXMLTPRB, FXCRTD, FXCRTU, FXCRTP, FXUPDD, FXUPDU, FXUPDP

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("FXCRTD", null);
            modified_values.put("FXUPDD", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("FXCRTD", makeDateTime(toLocalDate(newValues.get("FXCRTD")), toLocalTime(newValues.get("FXCRTT"))));
                modified_values.put("FXUPDD", makeDateTime(toLocalDate(newValues.get("FXUPDD")), toLocalTime(newValues.get("FXUPDT"))));
        } catch (Exception e) {
