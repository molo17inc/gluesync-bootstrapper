 ...
 * Entity: KBMEFCOADD.FJOBCST (DbMoto ReplicationID: 342)
 *
 * Decoded DbMoto field-mapping expressions:
 *   JCORDDATE <- MakeDateTime([JCORDDATE])
 *   JCPRMDATE <- MakeDateTime([JCPRMDATE])
 *   JCDUE600 <- MakeDateTime([JCDUE600])
 *   JCDUE850 <- MakeDateTime([JCDUE850])
 *   JCDUE900 <- MakeDateTime([JCDUE900])
 *   JCDUE950 <- MakeDateTime([JCDUE950])
 *   JCDUE1000 <- MakeDateTime([JCDUE1000])
 *   JCCOMP600 <- MakeDateTime([JCCOMP600])
 *   JCCOMP850 <- MakeDateTime([JCCOMP850])
 *   JCCOMP900 <- MakeDateTime([JCCOMP900])
 *   JCCOMP950 <- MakeDateTime([JCCOMP950])
 *   JCCOMP1000 <- MakeDateTime([JCCOMP1000])
 *   JCCSTSET <- MakeDateTime([JCCSTSET])
 *
 ...
 */
public class UDF_KBMEFCOADD_FJOBCST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: JCSLSORD, JCLINE, JCDASH, JCPROD, JCMPSPN, JCCO, JCCSTYP, JCESTPRF, JCESTYR, JCESTNBR, JCESTDSH, JCQTY, JCWONO, JCORDDATE, JCPRMDATE, JCDUE600, JCDUE850, JCDUE900, JCDUE950, JCDUE1000, JCCOMP600, JCCOMP850, JCCOMP900, JCCOMP950, JCCOMP1000, JCCSTSET, JCWCNO, JCSRVGRP, JCMANREV, JCMATCOST, JCLABORHR, JCFABHR, JCASSYHR, JCGLAZHR, JCOTHRHR, JCFINISH, JCGLASS, JCALUM, JCLABOR$, JCFAB$, JCASSY$, JCGLAZ$, JCOTHR$, JCFINISH$, JCGLASS$, JCALUM$, JCHDW$, JCBYOT$, JCOHD$, JCLINESTS, JCWOSTS, JCWOQTY, JCTOTQTY, JCALUMCST, JCMCPCT, JCGRSMARG, JCBOFLG, JCPTFLG, JCPS, JCFLAG1, JCFLAG2, JCFLAG3, JCFLAG4, JCREPNAM, JCREP, JCREISCST, JCBYEXT$, JCBYGLS$, JCWSYSTM, JCWDWTYPE, JCTHRMTYP, JCSTYPE, JCSTHRML, JCSPTYP, JCPTYP, JCPDCATSL, JCMULTPR, JCMODEL, JCJOBNAM, JCITRCO, JCISSL, JCISFB, JCFISCAL, JCEFDODC, JCCUST
        // Target columns: JCSLSORD, JCLINE, JCDASH, JCPROD, JCMPSPN, JCCO, JCCSTYP, JCESTPRF, JCESTYR, JCESTNBR, JCESTDSH, JCQTY, JCWONO, JCORDDATE, JCPRMDATE, JCDUE600, JCDUE850, JCDUE900, JCDUE950, JCDUE1000, JCCOMP600, JCCOMP850, JCCOMP900, JCCOMP950, JCCOMP1000, JCCSTSET, JCWCNO, JCSRVGRP, JCMANREV, JCMATCOST, JCLABORHR, JCFABHR, JCASSYHR, JCGLAZHR, JCOTHRHR, JCFINISH, JCGLASS, JCALUM, JCLABOR$, JCFAB$, JCASSY$, JCGLAZ$, JCOTHR$, JCFINISH$, JCGLASS$, JCALUM$, JCHDW$, JCBYOT$, JCOHD$, JCLINESTS, JCWOSTS, JCWOQTY, JCTOTQTY, JCALUMCST, JCMCPCT, JCGRSMARG, JCBOFLG, JCPTFLG, JCPS, JCFLAG1, JCFLAG2, JCFLAG3, JCFLAG4, JCREPNAM, JCREP, JCMULTPR, JCEFDODC, JCSPTYP, JCPDCATSL, JCISFB, JCISSL, JCTHRMTYPE, JCSTHRML, JCPTYP, JCSTYPE, JCWDWTYPE, JCWSYSTM, JCMODEL, JCFISCAL, JCITRCO, JCCUST, JCJOBNAM, JCREISCST, JCBYEXT$, JCBYGLS$

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("JCORDDATE", null);
            modified_values.put("JCPRMDATE", null);
            modified_values.put("JCDUE600", null);
            modified_values.put("JCDUE850", null);
            modified_values.put("JCDUE900", null);
            modified_values.put("JCDUE950", null);
            modified_values.put("JCDUE1000", null);
            modified_values.put("JCCOMP600", null);
            modified_values.put("JCCOMP850", null);
            modified_values.put("JCCOMP900", null);
            modified_values.put("JCCOMP950", null);
            modified_values.put("JCCOMP1000", null);
            modified_values.put("JCCSTSET", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("JCORDDATE", makeDateTime(toLocalDate(newValues.get("JCORDDATE"))));
                modified_values.put("JCPRMDATE", makeDateTime(toLocalDate(newValues.get("JCPRMDATE"))));
                modified_values.put("JCDUE600", makeDateTime(toLocalDate(newValues.get("JCDUE600"))));
                modified_values.put("JCDUE850", makeDateTime(toLocalDate(newValues.get("JCDUE850"))));
                modified_values.put("JCDUE900", makeDateTime(toLocalDate(newValues.get("JCDUE900"))));
                modified_values.put("JCDUE950", makeDateTime(toLocalDate(newValues.get("JCDUE950"))));
                modified_values.put("JCDUE1000", makeDateTime(toLocalDate(newValues.get("JCDUE1000"))));
                modified_values.put("JCCOMP600", makeDateTime(toLocalDate(newValues.get("JCCOMP600"))));
                modified_values.put("JCCOMP850", makeDateTime(toLocalDate(newValues.get("JCCOMP850"))));
                modified_values.put("JCCOMP900", makeDateTime(toLocalDate(newValues.get("JCCOMP900"))));
                modified_values.put("JCCOMP950", makeDateTime(toLocalDate(newValues.get("JCCOMP950"))));
                modified_values.put("JCCOMP1000", makeDateTime(toLocalDate(newValues.get("JCCOMP1000"))));
                modified_values.put("JCCSTSET", makeDateTime(toLocalDate(newValues.get("JCCSTSET"))));
        } catch (Exception e) {
