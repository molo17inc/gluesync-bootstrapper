 ...
 * Entity: INTRANET.TT_TASK (DbMoto ReplicationID: 240)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DATE_COMPLETE <- MakeDateTime([DATE_COMPLETE])
 *   DATE_STARTED <- MakeDateTime([DATE_STARTED])
 *   DATE_REQ <- MakeDateTime([DATE_REQ])
 *   ROLL_OUT_DATE <- MakeDateTime([ROLL_OUT_DATE])
 *   EST_COMPLETE_DATE <- MakeDateTime([EST_COMPLETE_DATE])
 *
...
public class UDF_INTRANET_TT_TASK {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DATE_COMPLETE", null);
            modified_values.put("DATE_STARTED", null);
            modified_values.put("DATE_REQ", null);
            modified_values.put("ROLL_OUT_DATE", null);
            modified_values.put("EST_COMPLETE_DATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DATE_COMPLETE", makeDateTime(toLocalDate(newValues.get("DATE_COMPLETE"))));
                modified_values.put("DATE_STARTED", makeDateTime(toLocalDate(newValues.get("DATE_STARTED"))));
                modified_values.put("DATE_REQ", makeDateTime(toLocalDate(newValues.get("DATE_REQ"))));
                modified_values.put("ROLL_OUT_DATE", makeDateTime(toLocalDate(newValues.get("ROLL_OUT_DATE"))));
                modified_values.put("EST_COMPLETE_DATE", makeDateTime(toLocalDate(newValues.get("EST_COMPLETE_DATE"))));
        } catch (Exception e) {
