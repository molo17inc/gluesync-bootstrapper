 ...
 * Entity: KBM400D011.MGLPOST (DbMoto ReplicationID: 252)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DTETRNDATE <- MakeDateTime("YYYYMMDD",[DTETRN])
 *
 ...
 */
public class UDF_KBM400D011_MGLPOST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: ACT, AMTDOL, APP, AUDOPR, AUDTIM, DOCSRC, DTETRN, FISCAL, FSCLCC, GLREF, GLREV, LINED, LOC, MFG, PERIOD, QTR, QTYAMT, REFER, STQTY, UNITS, WEEK, YEAR
        // Target columns: RECORDID, ACT, AMTDOL, APP, AUDOPR, AUDTIM, DOCSRC, DTETRN, FISCAL, FSCLCC, GLREF, GLREV, LINED, LOC, MFG, PERIOD, QTR, QTYAMT, REFER, STQTY, UNITS, WEEK, YEAR, DTETRNDATE

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DTETRNDATE", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DTETRNDATE", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("DTETRN"))));
