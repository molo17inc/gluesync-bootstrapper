 ...
 * Entity: ESPRODLIB.FQTYDSC (DbMoto ReplicationID: 1067)
 *
 * Decoded DbMoto field-mapping expressions:
 *   QDUPDDT <- MakeDateTime([QDUPDD], [QDUPDT])
 *   QDSRTDT <- MakeDateTime([QDSRTD], [QDCRTT])
 *
 ...
 */
public class UDF_ESPRODLIB_FQTYDSC {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: QDPGMN, QDUPDU, QDCRTU, QDUPDT, QDCRTT, QDUPDD, QDSRTD, QDCODE, QDUSER, QDTIME, QDDATE, QDPCT, QDBRK, QDSER, QDCAT, QDMOD, QDPAR, QDCO
        // Target columns: QDPGMN, QDUPDU, QDCRTU, QDUPDDT, QDSRTDT, QDCODE, QDUSER, QDDATE, QDPCT, QDBRK, QDSER, QDCAT, QDMOD, QDPAR, QDCO

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("QDUPDDT", null);
            modified_values.put("QDSRTDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("QDUPDDT", makeDateTime(toLocalDate(newValues.get("QDUPDD")), toLocalTime(newValues.get("QDUPDT"))));
                modified_values.put("QDSRTDT", makeDateTime(toLocalDate(newValues.get("QDSRTD")), toLocalTime(newValues.get("QDCRTT"))));
        } catch (Exception e) {
