 ...
 * Entity: INTRANET.EPS_DETAIL (DbMoto ReplicationID: 222)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SHIP_DATE <- MakeDateTime([SHIP_DATE])
 *   ON_QUEUE_DATE <- MakeDateTime([ON_QUEUE_DATE])
 *   RELEASE_DATE <- MakeDateTime([RELEASE_DATE])
 *   PULL_DATE <- MakeDateTime([PULL_DATE])
 *   START_DATE <- MakeDateTime([START_DATE])
 *   FINISH_DATE <- MakeDateTime([FINISH_DATE])
 *   POSTEEL <- MakeDateTime([POSTEEL])
 *   POPAINT <- MakeDateTime([POPAINT])
 *   POHARDWARE <- MakeDateTime([POHARDWARE])
 *   POMETAL <- MakeDateTime([POMETAL])
 *   POGLASS <- MakeDateTime([POGLASS])
 *   MFG_START_DATE <- MakeDateTime([MFG_START_DATE])
 *
 ...
 */
public class UDF_INTRANET_EPS_DETAIL {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SHIP_DATE", null);
            modified_values.put("ON_QUEUE_DATE", null);
            modified_values.put("RELEASE_DATE", null);
            modified_values.put("PULL_DATE", null);
            modified_values.put("START_DATE", null);
            modified_values.put("FINISH_DATE", null);
            modified_values.put("POSTEEL", null);
            modified_values.put("POPAINT", null);
            modified_values.put("POHARDWARE", null);
            modified_values.put("POMETAL", null);
            modified_values.put("POGLASS", null);
            modified_values.put("MFG_START_DATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SHIP_DATE", makeDateTime(toLocalDate(newValues.get("SHIP_DATE"))));
                modified_values.put("ON_QUEUE_DATE", makeDateTime(toLocalDate(newValues.get("ON_QUEUE_DATE"))));
                modified_values.put("RELEASE_DATE", makeDateTime(toLocalDate(newValues.get("RELEASE_DATE"))));
                modified_values.put("PULL_DATE", makeDateTime(toLocalDate(newValues.get("PULL_DATE"))));
                modified_values.put("START_DATE", makeDateTime(toLocalDate(newValues.get("START_DATE"))));
                modified_values.put("FINISH_DATE", makeDateTime(toLocalDate(newValues.get("FINISH_DATE"))));
                modified_values.put("POSTEEL", makeDateTime(toLocalDate(newValues.get("POSTEEL"))));
                modified_values.put("POPAINT", makeDateTime(toLocalDate(newValues.get("POPAINT"))));
                modified_values.put("POHARDWARE", makeDateTime(toLocalDate(newValues.get("POHARDWARE"))));
                modified_values.put("POMETAL", makeDateTime(toLocalDate(newValues.get("POMETAL"))));
                modified_values.put("POGLASS", makeDateTime(toLocalDate(newValues.get("POGLASS"))));
                modified_values.put("MFG_START_DATE", makeDateTime(toLocalDate(newValues.get("MFG_START_DATE"))));
        } catch (Exception e) {
