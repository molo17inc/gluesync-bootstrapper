 ...
 * Entity: KBM400MFG.FTCNTMST (DbMoto ReplicationID: 282)
 *
 * Decoded DbMoto field-mapping expressions:
 *   CZUDATE <- MakeDateTime( MakeDateTime ("YYYYMMDD",[CZUDTE]), [CZUTIM])
 *
 ...
 */
public class UDF_KBM400MFG_FTCNTMST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CZCO, CZEML, CZFAX, CZKEY, CZKLNG, CZNAME, CZNOTE, CZPHN, CZSEQ, CZSKA1, CZSKA2, CZSKA3, CZSKN1, CZSKN2, CZSKN3, CZTITL, CZTYPE, CZUDTE, CZUEVT, CZUPGM, CZUTGT, CZUTIM, CZUUSR
        // Target columns: CZCO, CZEML, CZFAX, CZKEY, CZKLNG, CZNAME, CZNOTE, CZPHN, CZSEQ, CZSKA1, CZSKA2, CZSKA3, CZSKN1, CZSKN2, CZSKN3, CZTITL, CZTYPE, CZUDATE, CZUEVT, CZUPGM, CZUTGT, CZUUSR

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("CZUDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("CZUDATE", makeDateTime((LocalDate)makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("CZUDTE"))), toBigDecimal(newValues.get("CZUTIM"))));
        } catch (Exception e) {
