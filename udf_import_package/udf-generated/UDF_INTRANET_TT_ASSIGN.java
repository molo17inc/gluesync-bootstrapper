 ...
 * Entity: INTRANET.TT_ASSIGN (DbMoto ReplicationID: 233)
 *
 * Decoded DbMoto field-mapping expressions:
 *   EST_COMPLETE <- MakeDateTime([EST_COMPLETE])
 *
 ...
 */
public class UDF_INTRANET_TT_ASSIGN {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: ASSIGN_ID, EMPLOYEE_ID, TASK_ID, EST_HOURS, EST_COMPLETE, ASSIGN_COMPLETE, PRIORITY, ROLE_ID, TEXT_ROLE
        // Target columns: ASSIGN_ID, EMPLOYEE_ID, TASK_ID, EST_HOURS, EST_COMPLETE, ASSIGN_COMPLETE, PRIORITY, ROLE_ID, TEXT_ROLE

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("EST_COMPLETE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("EST_COMPLETE", makeDateTime(toLocalDate(newValues.get("EST_COMPLETE"))));
        } catch (Exception e) {
