 ...
 * Entity: EPMMETRICS.ITP26BX1 (DbMoto ReplicationID: 199)
 *
 ...
 */
public class UDF_EPMMETRICS_ITP26BX1 {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SEQNUM, TSCO, YEAR, PERIOD, WEEK, TSDTTR, WRKCNT, WOSLNO, TSREFN, TSDFOR, RCODE, REISDSC, TSTAGN, TSPN, TSTQTY, ACTCST
        // Target columns: SEQNUM, TSCO, YEAR, PERIOD, WEEK, TSDTTR, WRKCNT, WOSLNO, TSREFN, TSDFOR, RCODE, REISDSC, TSTAGN, TSPN, TSTQTY, ACTCST
