 ...
 * Entity: KBMEFCOADD.FREISWOSUP (DbMoto ReplicationID: 654)
 *
 * Decoded DbMoto field-mapping expressions:
 *   RSNEEDDATE <- MakeDateTime([RSNEEDDATE])
 *   RSCRTDATETIME <- MakeDateTime([RSCRTDATE],[RSCRTTIME])
 *
 ...
 */
public class UDF_KBMEFCOADD_FREISWOSUP {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: RSCO, RSSEQ#, RSWONO, RSWONO_2, RSWONO_3, RSPART, RSPART_2, RSPART_3, RSQTY, RSRICODE, RSFINISH, RSNEEDDATE, RSPRIORITY, RSREQESTWC, RSCAUSEWC, RSSPLIT, RSMPSPART, RSORIGINWO, RSCOMMENT, RSCRTDATE, RSCRTTIME, RSCRTUSER, RSCRTPRGM, RSFINALWC
        // Target columns: RSCO, RSSEQ#, RSWONO, RSWONO_2, RSWONO_3, RSPART, RSPART_2, RSPART_3, RSQTY, RSRICODE, RSFINISH, RSNEEDDATE, RSPRIORITY, RSREQESTWC, RSCAUSEWC, RSSPLIT, RSMPSPART, RSORIGINWO, RSCOMMENT, RSCRTDATETIME, RSCRTUSER, RSCRTPRGM, RSFINALWC

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("RSNEEDDATE", null);
            modified_values.put("RSCRTDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("RSNEEDDATE", makeDateTime(toLocalDate(newValues.get("RSNEEDDATE"))));
                modified_values.put("RSCRTDATETIME", makeDateTime(toLocalDate(newValues.get("RSCRTDATE")), toLocalTime(newValues.get("RSCRTTIME"))));
        } catch (Exception e) {
