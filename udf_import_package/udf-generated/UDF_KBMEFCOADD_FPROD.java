 ...
 * Entity: KBMEFCOADD.FPROD (DbMoto ReplicationID: 319)
 *
 * Decoded DbMoto field-mapping expressions:
 *   EFCRTD <- MakeDateTime([EFCRTD],[EFCRTT])
 *   EFUPDD <- MakeDateTime([EFUPDD],[EFUPDT])
 *
...
public class UDF_KBMEFCOADD_FPROD {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("EFCRTD", null);
            modified_values.put("EFUPDD", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("EFCRTD", makeDateTime(toLocalDate(newValues.get("EFCRTD")), toLocalTime(newValues.get("EFCRTT"))));
                modified_values.put("EFUPDD", makeDateTime(toLocalDate(newValues.get("EFUPDD")), toLocalTime(newValues.get("EFUPDT"))));
        } catch (Exception e) {
