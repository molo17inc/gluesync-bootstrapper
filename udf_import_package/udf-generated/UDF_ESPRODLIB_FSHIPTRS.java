 ...
 * Entity: ESPRODLIB.FSHIPTRS (DbMoto ReplicationID: 695)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SHSHDATE <- MakeDateTime([SHSHDT])
 *   SXCRTDATETIME <- MakeDateTime([SXCRTD],[SXCRTT])
 *   SXUPDDATE <- MakeDateTime([SXUPDD],[SXUPDT])
 *
 ...
 */
public class UDF_ESPRODLIB_FSHIPTRS {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SHCO, SHYR, SHNBR, SHDSH, SHITEM, SHCART, SHCQTY, SHCDES, SHCPCK, SHPSUP, SHPCO, SHTRID, SHTLOD, SHLSUP, SHLCO, SHBLNO, SHSHDT, SHSHUR, SHSCO, SHPKIT, SHLDIT, SHSPIT, SXCRTD, SXUPDD, SXCRTT, SXUPDT, SXCRTU, SXUPDU, SXPGMN, LOCATE, SHUSEQ
        // Target columns: SHCO, SHYR, SHNBR, SHDSH, SHITEM, SHCART, SHCQTY, SHCDES, SHCPCK, SHPSUP, SHPCO, SHTRID, SHTLOD, SHLSUP, SHLCO, SHBLNO, SHSHDATE, SHSHUR, SHSCO, SHPKIT, SHLDIT, SHSPIT, SXCRTDATETIME, SXUPDDATE, SXCRTU, SXUPDU, SXPGMN, LOCATE, SHUSEQ

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SHSHDATE", null);
            modified_values.put("SXCRTDATETIME", null);
            modified_values.put("SXUPDDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SHSHDATE", makeDateTime(toLocalDate(newValues.get("SHSHDT"))));
                modified_values.put("SXCRTDATETIME", makeDateTime(toLocalDate(newValues.get("SXCRTD")), toLocalTime(newValues.get("SXCRTT"))));
                modified_values.put("SXUPDDATE", makeDateTime(toLocalDate(newValues.get("SXUPDD")), toLocalTime(newValues.get("SXUPDT"))));
        } catch (Exception e) {
