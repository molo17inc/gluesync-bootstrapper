 ...
 * Entity: ESPRODLIB.FTPGSCST (DbMoto ReplicationID: 1069)
 *
 * Decoded DbMoto field-mapping expressions:
 *   CSUPDDT <- MakeDateTime([CSUPDD], [CSUPDT])
 *   CSCRTDT <- MakeDateTime([CSCRTD], [CSCRTT])
 *
...
public class UDF_ESPRODLIB_FTPGSCST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("CSUPDDT", null);
            modified_values.put("CSCRTDT", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("CSUPDDT", makeDateTime(toLocalDate(newValues.get("CSUPDD")), toLocalTime(newValues.get("CSUPDT"))));
                modified_values.put("CSCRTDT", makeDateTime(toLocalDate(newValues.get("CSCRTD")), toLocalTime(newValues.get("CSCRTT"))));
