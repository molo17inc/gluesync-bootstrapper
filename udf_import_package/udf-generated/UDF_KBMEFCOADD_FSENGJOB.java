 ...
 * Entity: KBMEFCOADD.FSENGJOB (DbMoto ReplicationID: 327)
 *
 ...
 *   SEJCrtDtTm <- MakeDateTime([SEJCRTDT],[SEJCRTTM])
 *   SEJUpdDtTm <- MakeDateTime([SEJUPDDT],[SEJUPDTM])
 *
 ...
 */
public class UDF_KBMEFCOADD_FSENGJOB {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SECO, SEUSERID, SESLSORD, SESCHTYPE, SESCHNUM, SESCHSEQ, SESCHDATE, SEYEAR, SEWEEK, SESTARTDTE, SESTRLDUE, SESCHHRS, SEHRSCOMPL, SECMPLDATE, SESTATUS, SEJCUSER, SEJCPGMN, SEJCRTDT, SEJCRTTM, SEJUUSER, SEJUPGMN, SEJUPDDT, SEJUPDTM
        // Target columns: SECo, SEUserId, SESlsOrd, SESchType, SESchNum, SESchSeq, SESchDate, SEYear, SEWeek, SEStartDte, SEStrlDue, SESchHrs, SEHrsCompl, SECmplDate, SEStatus, SEJCUser, SEJCPgmn, SEJCrtDtTm, SEJUUser, SEJUpgmn, SEJUpdDtTm
        ...
        if (operation == MappingFunctionOperation.Delete) {
            ...
            modified_values.put("SEJCrtDtTm", null);
            modified_values.put("SEJUpdDtTm", null);
        ...
        try {
                ...
                modified_values.put("SEJCrtDtTm", makeDateTime(toLocalDate(newValues.get("SEJCRTDT")), toLocalTime(newValues.get("SEJCRTTM"))));
                modified_values.put("SEJUpdDtTm", makeDateTime(toLocalDate(newValues.get("SEJUPDDT")), toLocalTime(newValues.get("SEJUPDTM"))));
        } catch (Exception e) {
