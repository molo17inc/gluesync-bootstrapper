 ...
 * Generated by generate_udf_import_package.py on 2026-06-19 15:42:58
 * Entity: KBM400MFG.FLPODET (DbMoto ReplicationID: 271)
 *
 * Decoded DbMoto field-mapping expressions:
 *   PECSDATE <- LowDate(MakeDateTime([PECSMO],[PECSDA],[PECSYR],[PECSCT]))
 *   PECSDT <- MakeDateTime([PECSDT])
 *   PEDTA <- MakeDateTime("MMDDYY",[PEDTA])
 *   PEDTAK <- MakeDateTime([PEDTAK])
 *   PEDTK <- MakeDateTime("MMDDYY",[PEDTK])
 *   PEDTLR <- MakeDateTime([PEDTLR])
 *   PEDTO <- MakeDateTime("MMDDYY",[PEDTO])
 *   PEDTOR <- MakeDateTime([PEDTOR])
 *   PEMCDG <- MakeDateTime("MMDDYY",[PEMCDG])
 *   PEMCRC <- MakeDateTime([PEMCRC])
 *   PEMCRD <- MakeDateTime("CYYMMDD",[PEMCRD])
 *   PEMPDG <- MakeDateTime("MMDDYY",[PEMPDG])
 *   PEMPDR <- MakeDateTime("MMDDYY",[PEMPDR])
 *   PEMPRD <- MakeDateTime("MMDDYY",[PEMPRD])
 *   PEMVRD <- MakeDateTime("YYYYMMDD",[PEMVRD])
 *   PEUDTE <- MakeDateTime("YYYYMMDD",[PEUDTE])
 *   PRMCDR <- MakeDateTime("MMDDYY",[PRMCDR])
 *   PEMCGDATETM <- MakeDateTime([PEMCGN],[PEMCTG])
 *   PEMCRDATETM <- MakeDateTime([PEMCRV],[PEMCTR])
 *   PEMPGDATETM <- MakeDateTime([PEMPGN],[PEMPTG])
 *   PEMPRDATETM <- MakeDateTime([PEMPRV],[PEMPTR])
 *
...
public class UDF_KBM400MFG_FLPODET {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("PECSDATE", null);
            modified_values.put("PECSDT", null);
            modified_values.put("PEDTA", null);
            modified_values.put("PEDTAK", null);
            modified_values.put("PEDTK", null);
            modified_values.put("PEDTLR", null);
            modified_values.put("PEDTO", null);
            modified_values.put("PEDTOR", null);
            modified_values.put("PEMCDG", null);
            modified_values.put("PEMCRC", null);
            modified_values.put("PEMCRD", null);
            modified_values.put("PEMPDG", null);
            modified_values.put("PEMPDR", null);
            modified_values.put("PEMPRD", null);
            modified_values.put("PEMVRD", null);
            modified_values.put("PEUDTE", null);
            modified_values.put("PRMCDR", null);
            modified_values.put("PEMCGDATETM", null);
            modified_values.put("PEMCRDATETM", null);
            modified_values.put("PEMPGDATETM", null);
            modified_values.put("PEMPRDATETM", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("PECSDATE", lowDate(makeDateTime(toBigDecimal(newValues.get("PECSMO")), toBigDecimal(newValues.get("PECSDA")), toBigDecimal(newValues.get("PECSYR")), toBigDecimal(newValues.get("PECSCT")))));
                modified_values.put("PECSDT", makeDateTime(toLocalDate(newValues.get("PECSDT"))));
                modified_values.put("PEDTA", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PEDTA"))));
                modified_values.put("PEDTAK", makeDateTime(toLocalDate(newValues.get("PEDTAK"))));
                modified_values.put("PEDTK", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PEDTK"))));
                modified_values.put("PEDTLR", makeDateTime(toLocalDate(newValues.get("PEDTLR"))));
                modified_values.put("PEDTO", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PEDTO"))));
                modified_values.put("PEDTOR", makeDateTime(toLocalDate(newValues.get("PEDTOR"))));
                modified_values.put("PEMCDG", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PEMCDG"))));
                modified_values.put("PEMCRC", makeDateTime(toLocalDate(newValues.get("PEMCRC"))));
                modified_values.put("PEMCRD", makeDateTime("CYYMMDD", toBigDecimal(newValues.get("PEMCRD"))));
                modified_values.put("PEMPDG", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PEMPDG"))));
                modified_values.put("PEMPDR", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PEMPDR"))));
                modified_values.put("PEMPRD", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PEMPRD"))));
                modified_values.put("PEMVRD", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("PEMVRD"))));
                modified_values.put("PEUDTE", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("PEUDTE"))));
                modified_values.put("PRMCDR", makeDateTime("MMDDYY", toBigDecimal(newValues.get("PRMCDR"))));
                modified_values.put("PEMCGDATETM", makeDateTime(toLocalDate(newValues.get("PEMCGN")), toBigDecimal(newValues.get("PEMCTG"))));
                modified_values.put("PEMCRDATETM", makeDateTime(toLocalDate(newValues.get("PEMCRV")), toBigDecimal(newValues.get("PEMCTR"))));
                modified_values.put("PEMPGDATETM", makeDateTime(toLocalDate(newValues.get("PEMPGN")), toBigDecimal(newValues.get("PEMPTG"))));
                modified_values.put("PEMPRDATETM", makeDateTime(toLocalDate(newValues.get("PEMPRV")), toBigDecimal(newValues.get("PEMPTR"))));
        } catch (Exception e) {
