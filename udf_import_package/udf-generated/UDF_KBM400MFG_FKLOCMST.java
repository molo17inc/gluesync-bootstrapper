 ...
 * Entity: KBM400MFG.FKLOCMST (DbMoto ReplicationID: 268)
 *
 * Decoded DbMoto field-mapping expressions:
 *   LMDATELR <- MakeDateTime([LMMOLR],[LMDALR],[LMYRLR],[LMCTLR])
 *   LMDCNT <- MakeDateTime("MMDDYY",[LMDCNT])
 *   LMDNCC <- MakeDateTime("MMDDYY",[LMDNCC])
 *   LMDTCC <- MakeDateTime([LMDTCC])
 *   LMDTLC <- MakeDateTime([LMDTLC])
 *   LMDTLR <- MakeDateTime([LMDTLR])
 *
...
public class UDF_KBM400MFG_FKLOCMST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("LMDATELR", null);
            modified_values.put("LMDCNT", null);
            modified_values.put("LMDNCC", null);
            modified_values.put("LMDTCC", null);
            modified_values.put("LMDTLC", null);
            modified_values.put("LMDTLR", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("LMDATELR", makeDateTime(toBigDecimal(newValues.get("LMMOLR")), toBigDecimal(newValues.get("LMDALR")), toBigDecimal(newValues.get("LMYRLR")), toBigDecimal(newValues.get("LMCTLR"))));
                modified_values.put("LMDCNT", makeDateTime("MMDDYY", toBigDecimal(newValues.get("LMDCNT"))));
                modified_values.put("LMDNCC", makeDateTime("MMDDYY", toBigDecimal(newValues.get("LMDNCC"))));
                modified_values.put("LMDTCC", makeDateTime(toLocalDate(newValues.get("LMDTCC"))));
                modified_values.put("LMDTLC", makeDateTime(toLocalDate(newValues.get("LMDTLC"))));
                modified_values.put("LMDTLR", makeDateTime(toLocalDate(newValues.get("LMDTLR"))));
        } catch (Exception e) {
