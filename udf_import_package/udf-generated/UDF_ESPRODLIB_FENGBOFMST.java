 ...
 * Entity: ESPRODLIB.FENGBOFMST (DbMoto ReplicationID: 205)
 *
 * Decoded DbMoto field-mapping expressions:
 *   BOCRTDT <- MakeDatetime([BOCRTD],[BOCRTT])
 *   BOUPDDT <- MakeDatetime([BOUPDD],[BOUPDT])
 *   BOEBLDT <- MakeDatetime([BOEBLD],[BOEBLT])
 *   BOFBLDT <- MakeDatetime([BOFBLD],[BOFBLT])
 *
...
public class UDF_ESPRODLIB_FENGBOFMST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("BOCRTDT", null);
            modified_values.put("BOUPDDT", null);
            modified_values.put("BOEBLDT", null);
            modified_values.put("BOFBLDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("BOCRTDT", makeDateTime(toLocalDate(newValues.get("BOCRTD")), toLocalTime(newValues.get("BOCRTT"))));
                modified_values.put("BOUPDDT", makeDateTime(toLocalDate(newValues.get("BOUPDD")), toLocalTime(newValues.get("BOUPDT"))));
                modified_values.put("BOEBLDT", makeDateTime(toLocalDate(newValues.get("BOEBLD")), toLocalTime(newValues.get("BOEBLT"))));
                modified_values.put("BOFBLDT", makeDateTime(toLocalDate(newValues.get("BOFBLD")), toLocalTime(newValues.get("BOFBLT"))));
        } catch (Exception e) {
