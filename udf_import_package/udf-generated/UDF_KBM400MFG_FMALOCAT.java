 ...
 * Entity: KBM400MFG.FMALOCAT (DbMoto ReplicationID: 275)
 *
 * Decoded DbMoto field-mapping expressions:
 *   ALDISS <- MakeDateTime("MMDDYY",[ALDISS])
 *   ALDATE1 <- MakeDateTime([ALMM1],[ALDD1],[ALYY1],[ALCC1])
 *   ALDATE <- MakeDateTime([ALMO],[ALDA],[ALYR],[ALCT])
 *   ALMSDT <- MakeDateTime(MakeDateTime("MMDDYY",[ALMSDT]),[ALMSTM])
 *   ALRVDATE <- MakeDateTime(MakeDateTime("MMDDYY",[ALRVDT]),[ALRVTM])
 *   WODTOR <- MakeDateTime("MMDDYY",[WODTOR])
 *
...
public class UDF_KBM400MFG_FMALOCAT {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("ALDISS", null);
            modified_values.put("ALDATE1", null);
            modified_values.put("ALDATE", null);
            modified_values.put("ALMSDT", null);
            modified_values.put("ALRVDATE", null);
            modified_values.put("WODTOR", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("ALDISS", makeDateTime("MMDDYY", toBigDecimal(newValues.get("ALDISS"))));
                modified_values.put("ALDATE1", makeDateTime(toBigDecimal(newValues.get("ALMM1")), toBigDecimal(newValues.get("ALDD1")), toBigDecimal(newValues.get("ALYY1")), toBigDecimal(newValues.get("ALCC1"))));
                modified_values.put("ALDATE", makeDateTime(toBigDecimal(newValues.get("ALMO")), toBigDecimal(newValues.get("ALDA")), toBigDecimal(newValues.get("ALYR")), toBigDecimal(newValues.get("ALCT"))));
                modified_values.put("ALMSDT", makeDateTime((LocalDate)makeDateTime("MMDDYY", toBigDecimal(newValues.get("ALMSDT"))), toBigDecimal(newValues.get("ALMSTM"))));
                modified_values.put("ALRVDATE", makeDateTime((LocalDate)makeDateTime("MMDDYY", toBigDecimal(newValues.get("ALRVDT"))), toBigDecimal(newValues.get("ALRVTM"))));
                modified_values.put("WODTOR", makeDateTime("MMDDYY", toBigDecimal(newValues.get("WODTOR"))));
