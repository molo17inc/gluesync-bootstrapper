 ...
 * Entity: KBMEFCOADD.FERRTRAC (DbMoto ReplicationID: 305)
 *
 * Decoded DbMoto field-mapping expressions:
 *   PRBDTE <- MakeDateTime([PRBDTE])
 *   PRRSDT <- MakeDateTime([PRRSDT])
 *   RBCRTDTM <- MakeDateTime([RBUPDD], [RBUPDT])
 *   RBUPDDTM <- MakeDateTime([RBCRTD],[RBCRTT])
 *   PRINVDATE <- MakeDateTime([PRINVDATE])
 *
 ...
 */
public class UDF_KBMEFCOADD_FERRTRAC {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CYEAR, CNMBRA, CDASH, PRBNBR, PRONO, PRPRJ, CMNO, PRUPBY, CMSLSM, PRBTYP, PRPDCT, PRWC, PRERR, PRSERR, PRBDTE, PRATTO, PRATFM, PRCNCT, PRMETH, PRCOST, PRAPCS, PRPRCS, PRBCCS, PRSCCS, PRRENT, PRAIRF, PRRSDT, PRMLT, PHISTO, ERCOMP, FSOFC, RBCRTD, RBUPDD, RBCRTT, RBUPDT, RBCRTU, RBUPDU, RBPGMN, PRINVNUM, PRINVDATE, PRCNTPHONE, PRCNTADD1, PRCNTADD2, PRCNTADD3, PRCNTADD4, PRCNTADD5, FSCON1
        // Target columns: CYEAR, CNMBRA, CDASH, PRBNBR, PRONO, PRPRJ, CMNO, PRUPBY, CMSLSM, PRBTYP, PRPDCT, PRWC, PRERR, PRSERR, PRBDTE, PRATTO, PRATFM, PRCNCT, PRMETH, PRCOST, PRAPCS, PRPRCS, PRBCCS, PRSCCS, PRRSDT, PRMLT, PHISTO, ERCOMP, FSOFC, RBCRTDTM, RBUPDDTM, RBCRTU, RBUPDU, RBPGMN, PRINVNUM, PRINVDATE

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("PRBDTE", null);
            modified_values.put("PRRSDT", null);
            modified_values.put("RBCRTDTM", null);
            modified_values.put("RBUPDDTM", null);
            modified_values.put("PRINVDATE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("PRBDTE", makeDateTime(toLocalDate(newValues.get("PRBDTE"))));
                modified_values.put("PRRSDT", makeDateTime(toLocalDate(newValues.get("PRRSDT"))));
                modified_values.put("RBCRTDTM", makeDateTime(toLocalDate(newValues.get("RBUPDD")), toLocalTime(newValues.get("RBUPDT"))));
                modified_values.put("RBUPDDTM", makeDateTime(toLocalDate(newValues.get("RBCRTD")), toLocalTime(newValues.get("RBCRTT"))));
                modified_values.put("PRINVDATE", makeDateTime(toLocalDate(newValues.get("PRINVDATE"))));
        } catch (Exception e) {
