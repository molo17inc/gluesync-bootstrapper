 ...
 * Entity: KBMEFCOADD.FWRKSCHDLB (DbMoto ReplicationID: 333)
 *
 * Decoded DbMoto field-mapping expressions:
 *   WKCOMPDTTM <- MakeDateTime([WKCOMPDATE],[WKCOMPTIME])
 *   RPDUE <- MakeDateTime([RPDUE])
 *   SHIPDATE2 <- MakeDateTime([SHIPDATE2])
 *
...
public class UDF_KBMEFCOADD_FWRKSCHDLB {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("WKCOMPDTTM", null);
            modified_values.put("RPDUE", null);
            modified_values.put("SHIPDATE2", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("WKCOMPDTTM", makeDateTime(toLocalDate(newValues.get("WKCOMPDATE")), toLocalTime(newValues.get("WKCOMPTIME"))));
                modified_values.put("RPDUE", makeDateTime(toLocalDate(newValues.get("RPDUE"))));
                modified_values.put("SHIPDATE2", makeDateTime(toLocalDate(newValues.get("SHIPDATE2"))));
        } catch (Exception e) {
