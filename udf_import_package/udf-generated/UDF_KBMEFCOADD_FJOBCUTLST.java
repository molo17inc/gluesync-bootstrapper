 ...
 * Entity: KBMEFCOADD.FJOBCUTLST (DbMoto ReplicationID: 1101)
 *
 * Decoded DbMoto field-mapping expressions:
 *   CTCRTDT <- MakeDateTime([CTCRTD], [CTCRTT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FJOBCUTLST {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CTPGMN, CTCRTU, CTCRTT, CTCRTD, CUTLIST, REMNANT, LENGTH, FMISCI, FCOLORI, FCLASSI, FTYPEI, FMISC, FCOLOR, FCLASS, FTYPE, PDCATE, OPTION, OPTDET, QUANTITY, PARTNUMBER, CDASH, CNMBR, CYEAR, ESTDSH, ESTNBR, ESTYR, ESTPRF, IMCO
        // Target columns: CTPGMN, CTCRTU, CTCRTDT, CUTLIST, REMNANT, LENGTH, FMISCI, FCOLORI, FCLASSI, FTYPEI, FMISC, FCOLOR, FCLASS, FTYPE, PDCATE, OPTION, OPTDET, QUANTITY, PARTNUMBER, ESTDSH, ESTNBR, ESTYR, ESTPRF, IMCO, CDASH, CNMBR, CYEAR, RecordID

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("CTCRTDT", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("CTCRTDT", makeDateTime(toLocalDate(newValues.get("CTCRTD")), toLocalTime(newValues.get("CTCRTT"))));
