 ...
 * Entity: KBMEFCOADD.FWOSTEPA (DbMoto ReplicationID: 332)
 *
 * Decoded DbMoto field-mapping expressions:
 *   WSOLDDTE <- MakeDateTime([WSOLDDTE])
 *   WSNEWDTE <- MakeDateTime([WSNEWDTE])
 *   WSCRTDTE <- LowDate(MakeDateTime([WSCRTDTE],[WSCRTTIM]))
 *
 ...
 */
public class UDF_KBMEFCOADD_FWOSTEPA {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: WSCO, WSWONO, WSSONO, WSOPNO, WSOLDDTE, WSNEWDTE, WSRSNCODE, WSCRTDTE, WSCRTTIM, WSCRTUSR, WSCRTPGM
        // Target columns: WSCO, WSWONO, WSSONO, WSOPNO, WSOLDDTE, WSNEWDTE, WSRSNCODE, WSCRTDTE, WSCRTUSR, WSCRTPGM

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("WSOLDDTE", null);
            modified_values.put("WSNEWDTE", null);
            modified_values.put("WSCRTDTE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("WSOLDDTE", makeDateTime(toLocalDate(newValues.get("WSOLDDTE"))));
                modified_values.put("WSNEWDTE", makeDateTime(toLocalDate(newValues.get("WSNEWDTE"))));
                modified_values.put("WSCRTDTE", lowDate(makeDateTime(toLocalDate(newValues.get("WSCRTDTE")), toLocalTime(newValues.get("WSCRTTIM")))));
        } catch (Exception e) {
