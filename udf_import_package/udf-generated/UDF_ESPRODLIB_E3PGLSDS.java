 ...
 * Entity: ESPRODLIB.E3PGLSDS (DbMoto ReplicationID: 1066)
 *
 * Decoded DbMoto field-mapping expressions:
 *   ANUPDDT <- MakeDateTime([ANUPDD], [ANUPDT])
 *   ANCRTDT <- MakeDateTime([ANCRTD], [ANCRTT])
 *
...
public class UDF_ESPRODLIB_E3PGLSDS {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("ANUPDDT", null);
            modified_values.put("ANCRTDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("ANUPDDT", makeDateTime(toLocalDate(newValues.get("ANUPDD")), toLocalTime(newValues.get("ANUPDT"))));
                modified_values.put("ANCRTDT", makeDateTime(toLocalDate(newValues.get("ANCRTD")), toLocalTime(newValues.get("ANCRTT"))));
        } catch (Exception e) {
