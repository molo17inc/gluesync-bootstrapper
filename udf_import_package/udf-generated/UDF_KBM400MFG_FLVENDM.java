 ...
 * Entity: KBM400MFG.FLVENDM (DbMoto ReplicationID: 273)
 *
 * Decoded DbMoto field-mapping expressions:
 *   VMADTE <- MakeDateTime("YYYYMMDD", [VMADTE])
 *   VMUDTE <- MakeDateTime("YYYYMMDD", [VMUDTE])
 *
...
public class UDF_KBM400MFG_FLVENDM {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("VMADTE", null);
            modified_values.put("VMUDTE", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("VMADTE", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("VMADTE"))));
                modified_values.put("VMUDTE", makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("VMUDTE"))));
        } catch (Exception e) {
