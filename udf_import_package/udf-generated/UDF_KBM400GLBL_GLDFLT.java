 ...
 * Entity: KBM400GLBL.GLDFLT (DbMoto ReplicationID: 257)
 *
 * Decoded DbMoto field-mapping expressions:
 *   DFCRTDATE <- MakeDateTime([DFCRTD],[DFCRTT])
 *   DFUPDDATE <- MakeDateTime([DFUPDD],[DFUPDT])
 *
...
public class UDF_KBM400GLBL_GLDFLT {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("DFCRTDATE", null);
            modified_values.put("DFUPDDATE", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("DFCRTDATE", makeDateTime(toLocalDate(newValues.get("DFCRTD")), toLocalTime(newValues.get("DFCRTT"))));
                modified_values.put("DFUPDDATE", makeDateTime(toLocalDate(newValues.get("DFUPDD")), toLocalTime(newValues.get("DFUPDT"))));
