 ...
 * Entity: KBM400GLBL.MBANKTRAN (DbMoto ReplicationID: 256)
 *
 ...
 */
public class UDF_KBM400GLBL_MBANKTRAN {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: ACTIVE, AMTDOL, APP, AUDOPR, AUDTIM, BANKNO, CURRCD, DOCEXT, DOCSRC, DTECLR, DTETRN, FISCAL, FORAMT, FSCLCC, NAMEID, PAYEE, PERIOD, REFER, TYPTRN, WEEK, YEAR
        // Target columns: ACTIVE, AMTDOL, APP, AUDOPR, AUDTIM, BANKNO, CURRCD, DOCEXT, DOCSRC, DTECLR, DTETRN, FISCAL, FORAMT, FSCLCC, NAMEID, PAYEE, PERIOD, REFER, TYPTRN, WEEK, YEAR
