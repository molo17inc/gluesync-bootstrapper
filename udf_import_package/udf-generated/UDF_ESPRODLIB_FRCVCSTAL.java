 ...
 * Entity: ESPRODLIB.FRCVCSTAL (DbMoto ReplicationID: 1087)
 *
 ...
 */
public class UDF_ESPRODLIB_FRCVCSTAL {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: RDPGMN, RDUPTU, RDUPTT, RDUPTD, RDCRTU, RDCRTT, RDCRTD, RCVFCT, RCVEXT
        // Target columns: RDPGMN, RDUPTU, RDUPTDT, RDCRTU, RDCRTDT, RCVFCT, RCVEXT
