 ...
 * Entity: ESPRODLIB.FEFMHR (DbMoto ReplicationID: 683)
 *
 * Decoded DbMoto field-mapping expressions:
 *   RELDATETIME <- MakeDateTime([RELDAT],[RELTIM])
 *   MHCRTDATETIME <- MakeDateTime([MHCRTD],[MHCRTT])
 *   MHUPDDATETIME <- MakeDateTime([MHUPDD],[MHUPDT])
 *
...
public class UDF_ESPRODLIB_FEFMHR {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("RELDATETIME", null);
            modified_values.put("MHCRTDATETIME", null);
            modified_values.put("MHUPDDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("RELDATETIME", makeDateTime(toLocalDate(newValues.get("RELDAT")), toBigDecimal(newValues.get("RELTIM"))));
                modified_values.put("MHCRTDATETIME", makeDateTime(toLocalDate(newValues.get("MHCRTD")), toLocalTime(newValues.get("MHCRTT"))));
                modified_values.put("MHUPDDATETIME", makeDateTime(toLocalDate(newValues.get("MHUPDD")), toLocalTime(newValues.get("MHUPDT"))));
        } catch (Exception e) {
