 ...
 * Entity: KBM400MFG.FHSHPHIS (DbMoto ReplicationID: 700)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SHODDATE <- MakeDateTime("YY",[SHODMO],[SHODDA],[SHODYR])
 *   SHSPRDATE <- MakeDateTime("YY",[SHSPRM],[SHSPRD],[SHSPRY])
 *   SHSREDATE <- MakeDateTime("YY",[SHSREM],[SHSRED],[SHSREY])
 *   SHLSDATE <- MakeDateTime([SHLSMO],[SHLSDA],[SHLSYR],[SHLSCT])
 *   SHINDATE <- MakeDateTime([SHINMO],[SHINDA],[SHINYR],[SHINCT])
 *   SHUDATETIME <- MakeDateTime([SHUDTE],[SHUTIM])
 *
...
public class UDF_KBM400MFG_FHSHPHIS {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SHODDATE", null);
            modified_values.put("SHSPRDATE", null);
            modified_values.put("SHSREDATE", null);
            modified_values.put("SHLSDATE", null);
            modified_values.put("SHINDATE", null);
            modified_values.put("SHUDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("SHODDATE", makeDateTime("YY", toBigDecimal(newValues.get("SHODMO")), toBigDecimal(newValues.get("SHODDA")), toBigDecimal(newValues.get("SHODYR"))));
                modified_values.put("SHSPRDATE", makeDateTime("YY", toBigDecimal(newValues.get("SHSPRM")), toBigDecimal(newValues.get("SHSPRD")), toBigDecimal(newValues.get("SHSPRY"))));
                modified_values.put("SHSREDATE", makeDateTime("YY", toBigDecimal(newValues.get("SHSREM")), toBigDecimal(newValues.get("SHSRED")), toBigDecimal(newValues.get("SHSREY"))));
                modified_values.put("SHLSDATE", makeDateTime(toBigDecimal(newValues.get("SHLSMO")), toBigDecimal(newValues.get("SHLSDA")), toBigDecimal(newValues.get("SHLSYR")), toBigDecimal(newValues.get("SHLSCT"))));
                modified_values.put("SHINDATE", makeDateTime(toBigDecimal(newValues.get("SHINMO")), toBigDecimal(newValues.get("SHINDA")), toBigDecimal(newValues.get("SHINYR")), toBigDecimal(newValues.get("SHINCT"))));
                modified_values.put("SHUDATETIME", makeDateTime((LocalDate)makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("SHUDTE"))), toBigDecimal(newValues.get("SHUTIM"))));
        } catch (Exception e) {
