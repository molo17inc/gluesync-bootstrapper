 ...
 * Entity: ESPRODLIB.E3PJBREQ (DbMoto ReplicationID: 202)
 *
 * Decoded DbMoto field-mapping expressions:
 *   AVCRTD <- MakeDateTime([AVCRTD],[AVCRTT])
 *   AVUPDD <- MakeDateTime([AVUPDD],[AVUPDT])
 *
 ...
 */
public class UDF_ESPRODLIB_E3PJBREQ {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: CYEAR, CNMBR, CDASH, ITMNO, MARK, PRTNB, CTQTY, CTLEN, JBFIN, JBFINI, DTL1, DTL2, FLOOR#, NOPRT, HSTATS, ORDATE, RECTIM, USER, DATSYS, TIMSYS, LFIRST, CP, NOTHRM, PDCATE, PARTDESC, TLTOOL, BRTOOL, AVCO, AVCRTD, AVUPDD, AVCRTT, AVUPDT, AVCRTU, AVUPDU, AVPGMN
        // Target columns: CYEAR, CNMBR, CDASH, ITMNO, MARK, PRTNB, CTQTY, CTLEN, JBFIN, JBFINI, DTL1, DTL2, FLOOR#, NOPRT, HSTATS, ORDATE, RECTIM, USER, DATSYS, TIMSYS, LFIRST, CP, NOTHRM, PDCATE, PARTDESC, TLTOOL, BRTOOL, AVCO, AVCRTD, AVUPDD, AVCRTU, AVUPDU, AVPGMN

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("AVCRTD", null);
            modified_values.put("AVUPDD", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("AVCRTD", makeDateTime(toLocalDate(newValues.get("AVCRTD")), toLocalTime(newValues.get("AVCRTT"))));
                modified_values.put("AVUPDD", makeDateTime(toLocalDate(newValues.get("AVUPDD")), toLocalTime(newValues.get("AVUPDT"))));
        } catch (Exception e) {
