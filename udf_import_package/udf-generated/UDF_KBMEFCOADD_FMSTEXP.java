 ...
 * Entity: KBMEFCOADD.FMSTEXP (DbMoto ReplicationID: 316)
 *
 * Decoded DbMoto field-mapping expressions:
 *   FMREDT <- MakeDateTime([FMREDT])
 *   FMRQDT <- MakeDateTime([FMRQDT])
 *   FMRELS <- MakeDateTime([FMRELS])
 *   FMESDT <- MakeDateTime([FMESDT])
 *   FMRVDT <- MakeDateTime([FMRVDT])
 *   FMFGDT <- MakeDateTime([FMFGDT])
 *   FMCRTDT <- MakeDateTime([FMCRTD],[FMCRTT])
 *   FMUPDDT <- MakeDateTime([FMUPDD],[FMUPDT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FMSTEXP {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: FMEXP#, FMJOB#, FMJBNM, FMRQBY, FMREDT, FMRQDT, FMNXDY, FM2NDY, FMGRND, FMSOTH, FMAGNM, FMAG#, FMCS#, FMSADN, FMSAD1, FMSAD2, FMSAD3, FMACCD, FMBILN, FMBIL1, FMBIL2, FMBIL3, FMCOM1, FMCOM2, FMCOM3, FMCOM4, FMCOM5, FMCOLL, FMPRPD, FMGLAS, FMSTAT, FMDLSL, FMNTRN, FMNTER, FMEXTR, FMOTHR, FMRELS, FMRLBY, FMESDT, FMRVDT, FMGLBD, FMSCRQ, FMFTYP, FMCLTP, FMGLT1, FMGLT2, FMGLT3, FMGLT4, FMGLT5, FMRMK1, FMRMK2, FMRMK3, FMVIA, FMREG, FMTER, FMSHIP, FMPO#, FMFGBY, FMFGDT, FMDELT, FMCO#, FMMLTPRB, FMCRTD, FMUPDD, FMCRTT, FMUPDT, FMCRTU, FMUPDU, FMPGMN, FMSACCD
        // Target columns: FMEXP#, FMJOB#, FMJBNM, FMRQBY, FMREDT, FMRQDT, FMNXDY, FM2NDY, FMGRND, FMSOTH, FMAGNM, FMAG#, FMCS#, FMSADN, FMSAD1, FMSAD2, FMSAD3, FMACCD, FMBILN, FMBIL1, FMBIL2, FMBIL3, FMCOM1, FMCOM2, FMCOM3, FMCOM4, FMCOM5, FMCOLL, FMPRPD, FMGLAS, FMSTAT, FMDLSL, FMNTRN, FMNTER, FMEXTR, FMOTHR, FMRELS, FMRLBY, FMESDT, FMRVDT, FMGLBD, FMSCRQ, FMFTYP, FMCLTP, FMGLT1, FMGLT2, FMGLT3, FMGLT4, FMGLT5, FMRMK1, FMRMK2, FMRMK3, FMVIA, FMREG, FMTER, FMSHIP, FMPO#, FMFGBY, FMFGDT, FMDELT, FMCO#, FMMLTPRB, FMCRTDT, FMUPDDT, FMCRTU, FMUPDU, FMPGMN, FMSACCD

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("FMREDT", null);
            modified_values.put("FMRQDT", null);
            modified_values.put("FMRELS", null);
            modified_values.put("FMESDT", null);
            modified_values.put("FMRVDT", null);
            modified_values.put("FMFGDT", null);
            modified_values.put("FMCRTDT", null);
            modified_values.put("FMUPDDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("FMREDT", makeDateTime(toLocalDate(newValues.get("FMREDT"))));
                modified_values.put("FMRQDT", makeDateTime(toLocalDate(newValues.get("FMRQDT"))));
                modified_values.put("FMRELS", makeDateTime(toLocalDate(newValues.get("FMRELS"))));
                modified_values.put("FMESDT", makeDateTime(toLocalDate(newValues.get("FMESDT"))));
                modified_values.put("FMRVDT", makeDateTime(toLocalDate(newValues.get("FMRVDT"))));
                modified_values.put("FMFGDT", makeDateTime(toLocalDate(newValues.get("FMFGDT"))));
                modified_values.put("FMCRTDT", makeDateTime(toLocalDate(newValues.get("FMCRTD")), toLocalTime(newValues.get("FMCRTT"))));
                modified_values.put("FMUPDDT", makeDateTime(toLocalDate(newValues.get("FMUPDD")), toLocalTime(newValues.get("FMUPDT"))));
        } catch (Exception e) {
