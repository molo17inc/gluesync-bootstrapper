 ...
 * Entity: KBMEFCOADD.FEKMLODH (DbMoto ReplicationID: 1128)
 *
 * Decoded DbMoto field-mapping expressions:
 *   LHUPDDATETIME <- MakeDateTime([LHUPDD],[LHUPDT])
 *   LHCRTDATETIME <- MakeDateTime([LHCRTD],[LHCRTT])
 *
 ...
 */
public class UDF_KBMEFCOADD_FEKMLODH {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: TIMMIN, TANK, STIME, STATUS, SDATE, PCOLOR, PCLASS, MILLS, LOAD, LHUPDU, LHUPDT, LHUPDD, LHPGMN, LHCRTU, LHCRTT, LHCRTD, EDATE, COLOR, CODE, CHCO, BEAM, AMPSET
        // Target columns: LHPGMN, LHUPDU, LHCRTU, LHUPDDATETIME, LHCRTDATETIME, PCOLOR, PCLASS, MILLS, EDATE, TANK, TIMMIN, AMPSET, BEAM, COLOR, CODE, STIME, SDATE, STATUS, LOAD, CHCO

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("LHUPDDATETIME", null);
            modified_values.put("LHCRTDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("LHUPDDATETIME", makeDateTime(toLocalDate(newValues.get("LHUPDD")), toLocalTime(newValues.get("LHUPDT"))));
                modified_values.put("LHCRTDATETIME", makeDateTime(toLocalDate(newValues.get("LHCRTD")), toLocalTime(newValues.get("LHCRTT"))));
        } catch (Exception e) {
