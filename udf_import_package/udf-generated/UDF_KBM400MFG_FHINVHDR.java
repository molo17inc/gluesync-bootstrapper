 ...
 * Entity: KBM400MFG.FHINVHDR (DbMoto ReplicationID: 262)
 *
 * Decoded DbMoto field-mapping expressions:
 *   INDUDATE <- MakeDateTime([INDUMO],[INDUDA],[INDUYR],[INDUCT])
 *   INHDATE <- MakeDateTime([INHMO],[INHDA],[INHYR],[INHCT])
 *   INHUDTTM <- MakeDateTime(MakeDateTime("YYYYMMDD",[INHUDE]), [INHUTI])
 *   INIDATE <- MakeDateTime([INIMO],[INIDA],[INIYR],[INICT])
 *   INRFDATETM <- MakeDateTime(MakeDateTime([INRFMO],[INRFDA],[INRFYR],[INRFCT]), [INRFTM])
 *
...
public class UDF_KBM400MFG_FHINVHDR {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("INDUDATE", null);
            modified_values.put("INHDATE", null);
            modified_values.put("INHUDTTM", null);
            modified_values.put("INIDATE", null);
            modified_values.put("INRFDATETM", null);
            modified_values.put("RECORDID", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("INDUDATE", makeDateTime(toBigDecimal(newValues.get("INDUMO")), toBigDecimal(newValues.get("INDUDA")), toBigDecimal(newValues.get("INDUYR")), toBigDecimal(newValues.get("INDUCT"))));
                modified_values.put("INHDATE", makeDateTime(toBigDecimal(newValues.get("INHMO")), toBigDecimal(newValues.get("INHDA")), toBigDecimal(newValues.get("INHYR")), toBigDecimal(newValues.get("INHCT"))));
                modified_values.put("INHUDTTM", makeDateTime((LocalDate)makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("INHUDE"))), toBigDecimal(newValues.get("INHUTI"))));
                modified_values.put("INIDATE", makeDateTime(toBigDecimal(newValues.get("INIMO")), toBigDecimal(newValues.get("INIDA")), toBigDecimal(newValues.get("INIYR")), toBigDecimal(newValues.get("INICT"))));
                modified_values.put("INRFDATETM", makeDateTime((LocalDate)makeDateTime(toBigDecimal(newValues.get("INRFMO")), toBigDecimal(newValues.get("INRFDA")), toBigDecimal(newValues.get("INRFYR")), toBigDecimal(newValues.get("INRFCT"))), toBigDecimal(newValues.get("INRFTM"))));
