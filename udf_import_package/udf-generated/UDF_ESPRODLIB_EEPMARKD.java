 ...
 * Entity: ESPRODLIB.EEPMARKD (DbMoto ReplicationID: 1176)
 *
 * Decoded DbMoto field-mapping expressions:
 *   MRUPDD <- MakeDateTime([MRUPDD],[MRUPDT])
 *   MRCRTD <- MakeDateTime([MRCRTD],[MRCRTT])
 *
...
public class UDF_ESPRODLIB_EEPMARKD {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("MRUPDD", null);
            modified_values.put("MRCRTD", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("MRUPDD", makeDateTime(toLocalDate(newValues.get("MRUPDD")), toLocalTime(newValues.get("MRUPDT"))));
                modified_values.put("MRCRTD", makeDateTime(toLocalDate(newValues.get("MRCRTD")), toLocalTime(newValues.get("MRCRTT"))));
        } catch (Exception e) {
