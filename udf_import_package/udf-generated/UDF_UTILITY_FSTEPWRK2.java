 ...
 * Entity: UTILITY.FSTEPWRK2 (DbMoto ReplicationID: 1130)
 *
 * Decoded DbMoto field-mapping expressions:
 *   WFPODTCR <- MakeDateTime([WFPODTCR])
 *   WFPECSDT <- MakeDateTime([WFPECSDT])
 *
 ...
 */
public class UDF_UTILITY_FSTEPWRK2 {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: WFREQQTY, WFPOQTY, WFPONO, WFPODTCR, WFPECSDT, WFIMPN, WFCO
        // Target columns: WFPODTCR, WFPECSDT, WFPOQTY, WFPONO, WFREQQTY, WFIMPN, WFCO

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("WFPODTCR", null);
            modified_values.put("WFPECSDT", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("WFPODTCR", makeDateTime(toLocalDate(newValues.get("WFPODTCR"))));
                modified_values.put("WFPECSDT", makeDateTime(toLocalDate(newValues.get("WFPECSDT"))));
        } catch (Exception e) {
