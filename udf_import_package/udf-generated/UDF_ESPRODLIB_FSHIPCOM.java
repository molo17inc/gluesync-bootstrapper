 ...
 * Entity: ESPRODLIB.FSHIPCOM (DbMoto ReplicationID: 693)
 *
 * Decoded DbMoto field-mapping expressions:
 *   SHCOMP <- MakeDateTime([SHCOMP])
 ...
 */
public class UDF_ESPRODLIB_FSHIPCOM {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        // Source columns: SHYR, SHNBR, SHDSH, SHCOMP, SXCO, SXCRTD, SXUPDD, SXCRTT, SXUPDT, SXCRTU, SXUPDU, SXPGMN
        // Target columns: SHYR, SHNBR, SHDSH, SHCOMP, SXCO, SXCRTDATETIME, SXUPDDATETIME, SXCRTU, SXUPDU, SXPGMN

        Map<String, Object> modified_values = newValues;

        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("SHCOMP", null);
        ...
        try {
                modified_values.put("SHCOMP", makeDateTime(toLocalDate(newValues.get("SHCOMP"))));
