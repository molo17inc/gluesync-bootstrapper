 ...
 * Entity: KBM400MFG.FMWODET (DbMoto ReplicationID: 277)
 *
 * Decoded DbMoto field-mapping expressions:
 *   WDACDATE <- MakeDateTime ("YY", [WDACMM] ,  [WDACDD] ,   [WDACYY]  )
 *   WDDUDATE <- MakeDateTime  ([WDDUMM], [WDDUDD], [WDDUYY], [WDDUCC])
 *   WDSTDATE <- MakeDateTime ("YY",[WDSTMM], [WDSTDD], [WDSTYY])
 *   WDUDATETIME <- MakeDateTime(MakeDateTime("YYYYMMDD",[WDUDTE]), [WDUTIM])
 *
...
public class UDF_KBM400MFG_FMWODET {
    ...
    public Pair<MappingFunctionOperation, Map<String, Object>> onChange(Map<String, Object> newValues, Map<String, Object> oldValues, MappingFunctionOperation operation, Logger logger) {
        ...
        if (operation == MappingFunctionOperation.Delete) {
            modified_values.put("WDACDATE", null);
            modified_values.put("WDDUDATE", null);
            modified_values.put("WDSTDATE", null);
            modified_values.put("WDUDATETIME", null);
            return new Pair<>(operation, modified_values);
        }

        try {
                modified_values.put("WDACDATE", makeDateTime("YY", toBigDecimal(newValues.get("WDACMM")), toBigDecimal(newValues.get("WDACDD")), toBigDecimal(newValues.get("WDACYY"))));
                modified_values.put("WDDUDATE", makeDateTime(toBigDecimal(newValues.get("WDDUMM")), toBigDecimal(newValues.get("WDDUDD")), toBigDecimal(newValues.get("WDDUYY")), toBigDecimal(newValues.get("WDDUCC"))));
                modified_values.put("WDSTDATE", makeDateTime("YY", toBigDecimal(newValues.get("WDSTMM")), toBigDecimal(newValues.get("WDSTDD")), toBigDecimal(newValues.get("WDSTYY"))));
                modified_values.put("WDUDATETIME", makeDateTime((LocalDate)makeDateTime("YYYYMMDD", toBigDecimal(newValues.get("WDUDTE"))), toBigDecimal(newValues.get("WDUTIM"))));
        } catch (Exception e) {
